...
import React168, { useCallback as useCallback126, useEffect as useEffect72, useMemo as useMemo125 } from "react";
...
import { useCallback as useCallback88, useMemo as useMemo94, useState as useState56 } from "react";

// src/helpers/use-menu-structure.tsx
import { useContext as useContext19, useMemo as useMemo37 } from "react";
...
import { useContext as useContext17, useMemo as useMemo33 } from "react";
...
var Checkmark = () => /* @__PURE__ */ jsx40("svg", {
  focusable: "false",
  role: "img",
  viewBox: "0 0 512 512",
  style,
...
import { useCallback as useCallback23, useEffect as useEffect14, useMemo as useMemo28, useRef as useRef12, useState as useState20 } from "react";
import ReactDOM4 from "react-dom";
import { jsx as jsx42, jsxs as jsxs12, Fragment as Fragment6 } from "react/jsx-runtime";
var container10 = {
  padding: "8px 10px",
  ...
  return /* @__PURE__ */ jsxs12(Fragment6, {
    children: [
      /* @__PURE__ */ jsxs12("button", {
        ...
        children: [
          selected ? /* @__PURE__ */ jsx42("div", {
            title: typeof selected.label === "string" ? selected.label : undefined,
            style: label2,
            children: selected?.label
          }) : null,
          /* @__PURE__ */ jsx42(Spacing, {
            x: 1
          }),
          " ",
          /* @__PURE__ */ jsx42(CaretDown, {})
        ]
      }),
      portalStyle ? ReactDOM4.createPortal(/* @__PURE__ */ jsx42("div", {
        style: fullScreenOverlay,
        children: /* @__PURE__ */ jsx42("div", {
          ...
          children: /* @__PURE__ */ jsx42(HigherZIndex, {
            ...
            children: /* @__PURE__ */ jsx42("div", {
              style: portalStyle,
              children: /* @__PURE__ */ jsx42(MenuContent, {
                onNextMenu: noop,
                onPreviousMenu: noop,
                values,
                onHide,
...
import { useContext as useContext16, useEffect as useEffect19, useMemo as useMemo32, useRef as useRef15 } from "react";
...
` + " ".repeat(difference));
  ...
  return /* @__PURE__ */ jsx44("textarea", {
    ref: inputRef,
    tabIndex,
    ...props,
    className: VERTICAL_SCROLLBAR_CLASSNAME,
...
var JSONViewer = ({ src }) => {
  ...
  return /* @__PURE__ */ jsx45(RemTextarea, {
...
// src/components/FilePreview.tsx
import { jsx as jsx46, jsxs as jsxs14, Fragment as Fragment7 } from "react/jsx-runtime";
var msgStyle = {
  fontSize: 13,
  color: "white",
...
var FilePreview = ({ fileType, src, currentAsset, assetMetadata }) => {
  ...
  if (fileType === "image") {
    return /* @__PURE__ */ jsx46("img", {
      src
    });
  }
  if (fileType === "json") {
    return /* @__PURE__ */ jsx46(JSONViewer, {
      src
    });
  }
  if (fileType === "txt") {
    return /* @__PURE__ */ jsx46(TextViewer, {
      src
    });
  }
...
var RenderPreview = ({ path, assetMetadata }) => {
  ...
  return /* @__PURE__ */ jsx47(FilePreview, {
    assetMetadata,
    currentAsset: path,
    fileType,
    src
...
import { jsx as jsx48, jsxs as jsxs15, Fragment as Fragment8 } from "react/jsx-runtime";
var viewBox = 100;
var lines = 8;
...
var StaticFilePreview = ({ currentAsset, assetMetadata }) => {
  ...
  return /* @__PURE__ */ jsx49(FilePreview, {
    currentAsset,
    fileType,
...
var VideoPreview = ({
  ...
  if (contentDimensions === null) {
    return /* @__PURE__ */ jsx50("div", {
      style: centeredContainer,
      children: /* @__PURE__ */ jsx50(Spinner, {
        duration: 0.5,
        size: 24
      })
    });
  }
  return /* @__PURE__ */ jsx50(CompWhenItHasDimensions, {
    contentDimensions,
    canvasSize,
    canvasContent,
    assetMetadata,
...
var CompWhenItHasDimensions = ({
  ...
  const { size: previewSize } = useContext16(Internals11.PreviewSizeContext);
  ...
  return /* @__PURE__ */ jsx50("div", {
    style: outer,
    children: canvasContent.type === "asset" ? /* @__PURE__ */ jsx50(StaticFilePreview, {
      assetMetadata,
      currentAsset: canvasContent.asset
    }) : canvasContent.type === "output" ? /* @__PURE__ */ jsx50(RenderPreview, {
      path: canvasContent.path,
      assetMetadata
    }) : /* @__PURE__ */ jsx50(PortalContainer, {
      contentDimensions,
      scale,
      xCorrection,
      yCorrection
...
var PortalContainer = ({ scale, xCorrection, yCorrection, contentDimensions }) => {
  const { checkerboard } = useContext16(CheckerboardContext);
...
var SizeSelector = () => {
  const { size, setSize } = useContext17(Internals12.PreviewSizeContext);
  const { canvasContent } = useContext17(Internals12.CompositionManager);
  ...
  const items = useMemo33(() => {
    return getUniqueSizes(size).map((newSize) => {
      return {
        ...
        leftItem: String(size.size) === String(newSize.size) ? /* @__PURE__ */ jsx51(Checkmark, {}) : null,
        subMenu: null,
        quickSwitcherLabel: null
      };
    });
  ...
  return /* @__PURE__ */ jsx51("div", {
    ...
    children: /* @__PURE__ */ jsx51(Combobox, {
...
// src/state/in-out.ts
import { createContext as createContext11, useContext as useContext18, useMemo as useMemo34 } from "react";
...
var useTimelineInOutFramePosition = () => {
  ...
  const state = useContext18(TimelineInOutContext);
...
var useTimelineSetInOutFramePosition = () => {
  const { setInAndOutFrames } = useContext18(SetTimelineInOutContext);
  return { setInAndOutFrames };
};

// src/components/TimelineInOutToggle.tsx
import { jsx as jsx53, jsxs as jsxs17, Fragment as Fragment9 } from "react/jsx-runtime";
  ...
  return /* @__PURE__ */ jsxs17(Fragment9, {
    children: [
      ...
      /* @__PURE__ */ jsx53(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx53(TimelineOutPointer, {
...
import { jsx as jsx56, jsxs as jsxs19, Fragment as Fragment10 } from "react/jsx-runtime";
var pickColor = () => {
  ...
  open.then((color) => {
    copyText(color.sRGBHex).then(() => {
      showNotification(/* @__PURE__ */ jsxs19(Fragment10, {
        children: [
          /* @__PURE__ */ jsx56(ColorDot, {
            color: color.sRGBHex
          }),
          " ",
          /* @__PURE__ */ jsx56(Spacing, {
            x: 1
          }),
          " Copied",
          " ",
...
var useMenuStructure = (closeMenu, readOnlyStudio) => {
  const { setSelectedModal } = useContext19(ModalsContext);
  const { checkerboard, setCheckerboard } = useContext19(CheckerboardContext);
  const { editorZoomGestures, setEditorZoomGestures } = useContext19(EditorZoomGesturesContext);
  const { editorShowRulers, setEditorShowRulers } = useContext19(EditorShowRulersContext);
  const { editorShowGuides, setEditorShowGuides } = useContext19(EditorShowGuidesContext);
  const { size, setSize } = useContext19(Internals15.PreviewSizeContext);
  const { type } = useContext19(StudioServerConnectionCtx).previewServerState;
  const {
    setSidebarCollapsedState,
    sidebarCollapsedStateLeft,
    sidebarCollapsedStateRight
  } = useContext19(SidebarContext);
  ...
  const structure = useMemo37(() => {
    let struct = [
      {
        id: "remotion",
        label: /* @__PURE__ */ jsx57(Row, {
          align: "center",
          justify: "center",
          children: /* @__PURE__ */ jsx57("svg", {
            width: ICON_SIZE,
            height: ICON_SIZE,
        ...
        items: [
          {
            ...
            subMenu: {
              ...
              items: sizes.map((newSize) => ({
                ...
                label: getPreviewSizeLabel(newSize),
                leftItem: String(newSize.size) === String(size.size) ? /* @__PURE__ */ jsx57(Checkmark, {}) : null,
                onClick: () => {
                  closeMenu();
                  setSize(() => newSize);
                },
          ...
          },
          {
            ...
            leftItem: editorZoomGestures ? /* @__PURE__ */ jsx57(Checkmark, {}) : null,
            subMenu: null,
          ...
          },
          {
            ...
            type: "item",
            value: "show-ruler",
            leftItem: editorShowRulers ? /* @__PURE__ */ jsx57(Checkmark, {}) : null,
            subMenu: null,
          ...
          },
          {
            ...
            type: "item",
            value: "show-guides",
            leftItem: editorShowGuides ? /* @__PURE__ */ jsx57(Checkmark, {}) : null,
            subMenu: null,
              ...
              items: [
                {
                  ...
                  keyHint: null,
                  label: "Responsive",
                  leftItem: sidebarCollapsedStateLeft === "responsive" ? /* @__PURE__ */ jsx57(Checkmark, {}) : null,
                  onClick: () => {
                    closeMenu();
                    setSidebarCollapsedState({
                      left: "responsive",
                ...
                },
                {
                  ...
                  keyHint: null,
                  label: "Expanded",
                  leftItem: sidebarCollapsedStateLeft === "expanded" ? /* @__PURE__ */ jsx57(Checkmark, {}) : null,
                  onClick: () => {
                    closeMenu();
                ...
                },
                {
                  ...
                  keyHint: null,
                  label: "Collapsed",
                  leftItem: sidebarCollapsedStateLeft === "collapsed" ? /* @__PURE__ */ jsx57(Checkmark, {}) : null,
                  onClick: () => {
                    closeMenu();
                    setSidebarCollapsedState({
                      left: "collapsed",
              ...
              items: [
                {
                  ...
                  keyHint: null,
                  label: "Expanded",
                  leftItem: sidebarCollapsedStateRight === "expanded" ? /* @__PURE__ */ jsx57(Checkmark, {}) : null,
                  onClick: () => {
                    closeMenu();
                ...
                },
                {
                  ...
                  keyHint: null,
                  label: "Collapsed",
                  leftItem: sidebarCollapsedStateRight === "collapsed" ? /* @__PURE__ */ jsx57(Checkmark, {}) : null,
                  onClick: () => {
                    closeMenu();
                    setSidebarCollapsedState({
                      left: null,
          ...
          },
          {
            ...
            type: "item",
            value: "checkerboard",
            leftItem: checkerboard ? /* @__PURE__ */ jsx57(Checkmark, {}) : null,
            subMenu: null,
...
import { useCallback as useCallback25, useMemo as useMemo38, useRef as useRef16, useState as useState25 } from "react";
import ReactDOM5 from "react-dom";
import { jsx as jsx58, jsxs as jsxs20, Fragment as Fragment11 } from "react/jsx-runtime";
var container13 = {
  fontSize: 13,
  color: "white",
  paddingLeft: 10,
...
var MenuItem = ({
  ...
  return /* @__PURE__ */ jsxs20(Fragment11, {
    children: [
      ...
      portalStyle ? ReactDOM5.createPortal(/* @__PURE__ */ jsx58("div", {
        className: "css-reset",
        style: outerStyle,
        children: /* @__PURE__ */ jsx58(HigherZIndex, {
          onEscape: onItemQuit,
          onOutsideClick: onItemQuit,
          children: /* @__PURE__ */ jsx58("div", {
            style: portalStyle,
            children: /* @__PURE__ */ jsx58(MenuContent, {
...
import { useContext as useContext20, useEffect as useEffect21, useState as useState27 } from "react";

// src/components/OpenEditorButton.tsx
import { useCallback as useCallback26, useMemo as useMemo39, useState as useState26 } from "react";
...
var OpenEditorButton = ({ type }) => {
  ...
  const openInEditorSvg = /* @__PURE__ */ jsx59("svg", {
    viewBox: "0 0 512 512",
    style: svgStyle,
...
var MenuBuildIndicator = () => {
  ...
  const ctx = useContext20(StudioServerConnectionCtx).previewServerState;
  ...
  return /* @__PURE__ */ jsxs21("div", {
    ...
    children: [
      showButton ? /* @__PURE__ */ jsx60(Spacing, {
        x: 2
      }) : null,
      isBuilding ? /* @__PURE__ */ jsx60("div", {
        style: spinner,
        children: /* @__PURE__ */ jsx60(Spinner, {
          duration: 0.5,
          size: spinnerSize
        })
      }) : /* @__PURE__ */ jsx60("div", {
      ...
      showButton ? /* @__PURE__ */ jsx60(OpenEditorButton, {
        type: "editor"
      }) : window.remotion_gitSource ? /* @__PURE__ */ jsx60(OpenEditorButton, {
        type: "git"
      }) : null
    ]
  });
...
import { useCallback as useCallback86, useContext as useContext54, useEffect as useEffect53 } from "react";

// src/components/TopPanel.tsx
import { useCallback as useCallback85, useContext as useContext53, useEffect as useEffect52, useMemo as useMemo92 } from "react";
...
import { useContext as useContext29, useMemo as useMemo50 } from "react";
import { Internals as Internals25 } from "remotion";

// src/components/CanvasOrLoading.tsx
import { useContext as useContext28, useEffect as useEffect32 } from "react";
...
var Overlay = () => {
  ...
  useImperativeHandle9(setErrorsRef, () => {
  ...
  return /* @__PURE__ */ jsx61(KeybindingContextProvider, {
    children: /* @__PURE__ */ jsx61(AbsoluteFill, {
      style: {
      ...
      children: errors.errors.map((err, i) => {
        return /* @__PURE__ */ jsx61(ErrorLoader, {
...
import { useCallback as useCallback28, useEffect as useEffect23 } from "react";
...
import { useCallback as useCallback30, useMemo as useMemo41, useRef as useRef17, useState as useState30 } from "react";
...
import { jsx as jsx69, jsxs as jsxs26, Fragment as Fragment12 } from "react/jsx-runtime";
var title2 = {
  marginBottom: 8,
  display: "flex",
  flexDirection: "row",
...
import { useCallback as useCallback31, useEffect as useEffect24 } from "react";
...
import { useCallback as useCallback33, useEffect as useEffect26 } from "react";
...
// src/error-overlay/remotion-overlay/ErrorDisplay.tsx
import { jsx as jsx76, jsxs as jsxs32, Fragment as Fragment13 } from "react/jsx-runtime";
var stack = {
  marginTop: 17,
  overflowX: "scroll",
  marginBottom: "10vh"
...
import { useContext as useContext23, useMemo as useMemo46 } from "react";
...
import { useContext as useContext21, useMemo as useMemo44 } from "react";
...
var useStudioCanvasDimensions = ({
  ...
  const { size: previewSize } = useContext21(Internals18.PreviewSizeContext);
...
import { memo, useCallback as useCallback35, useContext as useContext22, useMemo as useMemo45 } from "react";
...
var EditorGuides = ({ canvasSize, contentDimensions, assetMetadata }) => {
  ...
  const { canvasContent } = useContext23(Internals19.CompositionManager);
  if (canvasContent === null || canvasContent.type !== "composition") {
    throw new Error("Expected to be in a composition");
  }
  const { guidesList } = useContext23(EditorShowGuidesContext);
...
// src/components/EditorRuler/index.tsx
import { jsx as jsx81, jsxs as jsxs34, Fragment as Fragment15 } from "react/jsx-runtime";
...
var useIsRulerVisible = () => {
  const { canvasContent } = useContext26(Internals21.CompositionManager);
  const { editorShowRulers } = useContext26(EditorShowRulersContext);
...
// src/components/Canvas.tsx
import { jsx as jsx83, jsxs as jsxs35, Fragment as Fragment16 } from "react/jsx-runtime";
var container17 = {
  flex: 1,
  display: "flex",
  overflow: "hidden",
...
var Canvas = ({ canvasContent, size: size2, isRefreshing }) => {
  const { setSize, size: previewSize } = useContext27(Internals22.PreviewSizeContext);
  const { editorZoomGestures } = useContext27(EditorZoomGesturesContext);
  const keybindings = useKeybinding();
  const config = Internals22.useUnsafeVideoConfig();
  const areRulersVisible = useIsRulerVisible();
  const { editorShowGuides } = useContext27(EditorShowGuidesContext);
...
var RefreshCompositionOverlay = () => {
  return /* @__PURE__ */ jsx85(AbsoluteFill2, {
    style: container19,
...
// src/components/CanvasOrLoading.tsx
import { jsx as jsx86, jsxs as jsxs37, Fragment as Fragment17 } from "react/jsx-runtime";
var container20 = {
  color: "white",
  flex: 1,
  justifyContent: "center",
...
var CanvasOrLoading = ({ size: size2 }) => {
  ...
  const { setZoom } = useContext28(TimelineZoomCtx);
...
var CanvasIfSizeIsAvailable = () => {
  ...
  const context = useContext29(Internals25.CurrentScaleContext);
...
import { useCallback as useCallback39, useContext as useContext30, useEffect as useEffect33 } from "react";
...
// src/components/CurrentCompositionSideEffects.tsx
var TitleUpdater = () => {
  const renderQueue = useContext30(RenderQueueContext);
  const { canvasContent } = useContext30(Internals26.CompositionManager);
...
var CurrentCompositionKeybindings = ({ readOnlyStudio }) => {
  ...
  const { type } = useContext30(StudioServerConnectionCtx).previewServerState;
...
import React58, { useCallback as useCallback42, useContext as useContext31 } from "react";
...
var GlobalPropsEditorUpdateButton = ({ compositionId, currentDefaultProps }) => {
  ...
  const [disabled, setDisabled] = React58.useState(false);
...
import React63, { useCallback as useCallback44, useEffect as useEffect35, useMemo as useMemo55 } from "react";
...
var RenderModalJSONPropsEditor = ({
  ...
  const keybindings = useKeybinding();
  const [localValue, setLocalValue] = React63.useState(() => {
...
import { useCallback as useCallback64, useEffect as useEffect40, useMemo as useMemo75, useState as useState46 } from "react";
...
import React86, { useMemo as useMemo74, useState as useState45 } from "react";
...
import { createContext as createContext16, useContext as useContext33, useMemo as useMemo56 } from "react";
import { jsx as jsx99 } from "react/jsx-runtime";
var SCHEMA_EDITOR_FIELDSET_PADDING = 10;
var AlreadyPaddedRightContext = createContext16(false);
var Fieldset = ({ children, shouldPad }) => {
  const alreadyPadded = useContext33(AlreadyPaddedRightContext);
...
var defaultPropsEditorScrollableAreaRef = React65.createRef();
...
// src/components/RenderModal/SchemaEditor/SchemaSeparationLine.tsx
import { jsx as jsx103, jsxs as jsxs45, Fragment as Fragment18 } from "react/jsx-runtime";
...
import React72, { useMemo as useMemo64, useState as useState41 } from "react";
...
import { useCallback as useCallback49, useEffect as useEffect36, useMemo as useMemo62, useRef as useRef21, useState as useState39 } from "react";
...
// src/components/RenderModal/InfoBubble.tsx
import { jsx as jsx107, jsxs as jsxs48, Fragment as Fragment19 } from "react/jsx-runtime";
var icon3 = {
  color: LIGHT_TEXT,
  height: 15
};
...
var RevisionContext = createContext17({
...
var useLocalState = ({
  ...
  const parentRevision = useContext34(RevisionContext).childResetRevision;
        ...
        children: /* @__PURE__ */ jsxs50(SchemaVerticalGuide, {
          ...
          children: [
            localValue.value.map((child, i) => {
              return /* @__PURE__ */ jsxs50(React72.Fragment, {
                children: [
...
import React75, { useCallback as useCallback52, useEffect as useEffect38, useMemo as useMemo66, useRef as useRef23, useState as useState42 } from "react";
...
var InputDraggerForwardRefFn = ({
  ...
  const [inputFallback, setInputFallback] = useState42(false);
  ...
  const onKeyPress = useCallback52((e) => {
    if (e.key === "Enter") {
  ...
  const onPointerDown = useCallback52((e) => {
  ...
  if (inputFallback) {
    return /* @__PURE__ */ jsx113(HigherZIndex, {
      onEscape,
      onOutsideClick: noop,
      children: /* @__PURE__ */ jsx113(RemotionInput, {
        ref: fallbackRef,
        autoFocus: true,
        onKeyPress,
        onBlur,
  ...
  return /* @__PURE__ */ jsx113("button", {
    ...
    onClick,
    onPointerDown,
    children: /* @__PURE__ */ jsx113("span", {
      style: span,
      children: formatter(value)
    })
  });
};
var InputDragger = React75.forwardRef(InputDraggerForwardRefFn);
...
var ZodColorEditor = ({
  ...
  const onTextChange = useCallback53((e) => {
  ...
  const onOpacityChange = useCallback53((newValue) => {
  ...
  const onOpacityValueChange = useCallback53((newValue) => {
    const newColor = colorWithNewOpacity(localValue.value, Math.round(Number(newValue) / 100 * 255), zodTypes);
    onValueChange(() => newColor, false, false);
  }, [localValue.value, onValueChange, zodTypes]);
        ...
        children: [
          /* @__PURE__ */ jsxs53(Row, {
            ...
            children: [
              /* @__PURE__ */ jsx115("div", {
                style: colorPicker,
                children: /* @__PURE__ */ jsx115(RemInputTypeColor, {
                  type: "color",
                  style: {
                    height: 39
                  },
...
var ZodDateEditor = ({
  ...
  const onChange = useCallback54((e) => {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs54("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx116(ZodFieldValidation, {
            path: jsonPath,
            localValue
          })
        ]
...
var ZodDefaultEditor = ({
  ...
  return /* @__PURE__ */ jsx117(ZodSwitch, {
    defaultValue,
    jsonPath,
    onRemove,
    onSave,
...
var ZodDiscriminatedUnionEditor = ({
  ...
  const options = useMemo69(() => [...typedSchema.optionsMap.keys()], [typedSchema.optionsMap]);
  const {
    localValue,
    onChange: setLocalValue,
    reset
  ...
  const comboBoxValues = useMemo69(() => {
    return options.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: option === value[typedSchema.discriminator] ? /* @__PURE__ */ jsx118(Checkmark, {}) : null,
        onClick: () => {
  ...
  const discriminatedUnionReplacement = useMemo69(() => {
    return {
  ...
  return /* @__PURE__ */ jsx118(ZodObjectEditor, {
    jsonPath,
    mayPad,
    savedValue: defaultValue,
    onRemove,
...
var ZodEffectEditor = ({
  ...
  return /* @__PURE__ */ jsxs56(Fieldset, {
    ...
    children: [
      /* @__PURE__ */ jsx119("div", {
        style: fullWidth4,
        children: /* @__PURE__ */ jsx119(ZodSwitch, {
          value,
          setValue: onChange,
          jsonPath,
          schema: def.schema,
  ...
  const comboBoxValues = useMemo70(() => {
    return def.values.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: option === value ? /* @__PURE__ */ jsx120(Checkmark, {}) : null,
        onClick: (id) => {
  ...
  return /* @__PURE__ */ jsxs57(Fieldset, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx120("div", {
        ...
        children: /* @__PURE__ */ jsx120(Combobox, {
          values: comboBoxValues,
          selectedId: value,
          title: value
        })
...
import { jsx as jsx122, jsxs as jsxs59 } from "react/jsx-runtime";
var labelStyle4 = {
  fontFamily: "sans-serif",
  fontSize: 14,
  color: LIGHT_TEXT
...
var ZodOrNullishEditor = ({
  ...
  const onCheckBoxChange = useCallback58((e) => {
  ...
  return /* @__PURE__ */ jsxs59(Fieldset, {
    ...
    success: localValue.zodValidation.success,
    children: [
      localValue.value === nullishValue ? /* @__PURE__ */ jsx122(SchemaLabel, {
        handleClick: null,
        isDefaultValue: localValue.value === defaultValue,
        jsonPath,
        onReset: reset,
      ...
      /* @__PURE__ */ jsxs59("div", {
        ...
        children: [
          /* @__PURE__ */ jsx122(Checkbox, {
            checked: isChecked,
            onChange: onCheckBoxChange,
            disabled: false,
            name: jsonPath.join(".")
          }),
          /* @__PURE__ */ jsx122(Spacing, {
            x: 1
          }),
          /* @__PURE__ */ jsx122("div", {
            style: labelStyle4,
...
var ZodNumberEditor = ({
  ...
  const onNumberChange = useCallback59((newValue) => {
    setLocalValue(() => newValue, false, false);
  }, [setLocalValue]);
  const isDefault = localValue.value === defaultValue;
  const onTextChange = useCallback59((newValue) => {
...
var ZodOptionalEditor = ({
  ...
  const { innerType } = schema._def;
  return /* @__PURE__ */ jsx125(ZodOrNullishEditor, {
    defaultValue,
    jsonPath,
    onRemove,
    onSave,
...
import { useCallback as useCallback60, useMemo as useMemo71 } from "react";
  ...
  const comboBoxValues = useMemo71(() => {
    return getStaticFiles().map((option) => {
      return {
        ...
        id: option.src,
        keyHint: null,
        leftItem: option.src === value ? /* @__PURE__ */ jsx126(Checkmark, {}) : null,
        onClick: (id) => {
          setLocalValue(() => id, false, false);
        },
        quickSwitcherLabel: null,
  ...
  return /* @__PURE__ */ jsxs61(Fieldset, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx126("div", {
        ...
        children: /* @__PURE__ */ jsx126(Combobox, {
          values: comboBoxValues,
...
var ZodTextareaEditor = ({
  ...
  const onChange = useCallback62((e) => {
    setLocalValue(() => e.target.value, false, false);
  }, [setLocalValue]);
...
var ZodTupleItemEditor = ({
  ...
  const setValue = useCallback63((val) => {
    onChange((oldV) => [
      ...oldV.slice(0, index),
      typeof val === "function" ? val(oldV[index]) : val,
      ...oldV.slice(index + 1)
  ...
  const newJsonPath = useMemo72(() => [...jsonPath, index], [index, jsonPath]);
  ...
  return /* @__PURE__ */ jsx129("div", {
    children: /* @__PURE__ */ jsx129(ZodSwitch, {
      jsonPath: newJsonPath,
  ...
  return /* @__PURE__ */ jsxs64(Fieldset, {
    ...
    children: [
      /* @__PURE__ */ jsx130("div", {
        ...
        children: /* @__PURE__ */ jsx130(SchemaLabel, {
          onReset: reset,
          isDefaultValue,
          jsonPath,
          onRemove,
      ...
      expanded ? /* @__PURE__ */ jsx130(RevisionContextProvider, {
        children: /* @__PURE__ */ jsxs64(SchemaVerticalGuide, {
          ...
          children: [
            localValue.value.map((child, i) => {
              return /* @__PURE__ */ jsxs64(React85.Fragment, {
                children: [
                  /* @__PURE__ */ jsx130(ZodTupleItemEditor, {
                    onChange,
                    value: child,
                    def,
                    index: i,
                  ...
                  /* @__PURE__ */ jsx130(SchemaArrayItemSeparationLine, {
                    schema,
                    index: i,
                    onChange,
                    isLast: i === localValue.value.length - 1,
            ...
            value.length === 0 ? /* @__PURE__ */ jsx130(SchemaArrayItemSeparationLine, {
              schema,
              index: 0,
              onChange,
              isLast: true,
...
var ZodSwitch = ({
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodObject) {
    return /* @__PURE__ */ jsx132(ZodObjectEditor, {
      setValue,
      unsavedValue: value,
      savedValue: defaultValue,
      jsonPath,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodString) {
    if (value.startsWith(window.remotion_staticBase)) {
      return /* @__PURE__ */ jsx132(ZodStaticFileEditor, {
        setValue,
        value,
        jsonPath,
        schema,
    ...
    if (zodTypes && schema._def.description === zodTypes.ZodZypesInternals.REMOTION_TEXTAREA_BRAND) {
      return /* @__PURE__ */ jsx132(ZodTextareaEditor, {
        value,
        setValue,
        jsonPath,
        schema,
    ...
    return /* @__PURE__ */ jsx132(ZodStringEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDate) {
    return /* @__PURE__ */ jsx132(ZodDateEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodNumber) {
    return /* @__PURE__ */ jsx132(ZodNumberEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodBoolean) {
    return /* @__PURE__ */ jsx132(ZodBooleanEditor, {
      value,
      setValue,
      jsonPath,
      defaultValue,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodUndefined) {
    return /* @__PURE__ */ jsx132(ZonNonEditableValue, {
      jsonPath,
      showSaveButton,
      label: "undefined",
      saving,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodArray) {
    return /* @__PURE__ */ jsx132(ZodArrayEditor, {
      setValue,
      value,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodEnum) {
    return /* @__PURE__ */ jsx132(ZodEnumEditor, {
      setValue,
      value,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodEffects) {
    if (zodTypes && schema._def.description === zodTypes.ZodZypesInternals.REMOTION_COLOR_BRAND) {
      return /* @__PURE__ */ jsx132(ZodColorEditor, {
        value,
        setValue,
        jsonPath,
        schema,
    ...
    return /* @__PURE__ */ jsx132(ZodEffectEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodUnion) {
    return /* @__PURE__ */ jsx132(ZodUnionEditor, {
      schema,
      showSaveButton,
      jsonPath,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodOptional) {
    return /* @__PURE__ */ jsx132(ZodOptionalEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodNullable) {
    return /* @__PURE__ */ jsx132(ZodNullableEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDefault) {
    return /* @__PURE__ */ jsx132(ZodDefaultEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDiscriminatedUnion) {
    return /* @__PURE__ */ jsx132(ZodDiscriminatedUnionEditor, {
      defaultValue,
      mayPad,
      schema,
      setValue,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodTuple) {
    return /* @__PURE__ */ jsx132(ZodTupleEditor, {
      setValue,
      value,
      jsonPath,
      schema,
...
// src/components/RenderModal/SchemaEditor/ZodObjectEditor.tsx
import { jsx as jsx133, jsxs as jsxs65 } from "react/jsx-runtime";
var ZodObjectEditor = ({
  schema,
  jsonPath,
  setValue,
  ...
  const keys = Object.keys(shape);
  const isRoot = jsonPath.length === 0;
  const isDefaultValue = useMemo74(() => {
  ...
  return /* @__PURE__ */ jsxs65(Fieldset, {
    ...
    success: localValue.zodValidation.success,
    children: [
      isRoot ? null : /* @__PURE__ */ jsx133(SchemaLabel, {
        isDefaultValue,
        onReset: reset,
        jsonPath,
        onRemove,
      ...
      expanded ? /* @__PURE__ */ jsx133(RevisionContextProvider, {
        children: /* @__PURE__ */ jsx133(SchemaVerticalGuide, {
          isRoot,
          children: keys.map((key, i) => {
            ...
            return /* @__PURE__ */ jsxs65(React86.Fragment, {
              children: [
                /* @__PURE__ */ jsx133(ZodSwitch, {
                  mayPad: true,
                ...
                i === keys.length - 1 ? null : /* @__PURE__ */ jsx133(SchemaSeparationLine, {})
              ]
            }, key);
          })
        })
      }) : null,
      isRoot || !expanded ? null : /* @__PURE__ */ jsx133("div", {
        style: fieldsetLabel,
        children: "}"
      })
    ]
...
var SchemaEditor = ({
  ...
  const keybindings = useKeybinding();
  const [revision, setRevision] = useState46(0);
  const revisionState = useMemo75(() => {
    return {
  ...
  if (!zodValidationResult.success) {
    ...
    if (!defaultPropsValid.success) {
      return /* @__PURE__ */ jsx134(InvalidDefaultProps, {
        zodValidationResult
      });
    }
    return /* @__PURE__ */ jsx134(InvalidSchema, {
      reset,
      zodValidationResult
    });
  }
  if (typeName !== z.ZodFirstPartyTypeKind.ZodObject) {
    return /* @__PURE__ */ jsx134(TopLevelZodValue, {
  ...
  return /* @__PURE__ */ jsx134("div", {
    ...
    style: scrollable2,
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: /* @__PURE__ */ jsx134(RevisionContext.Provider, {
      value: revisionState,
      children: /* @__PURE__ */ jsx134(ZodObjectEditor, {
        discriminatedUnionReplacement: null,
...
import { useCallback as useCallback65, useMemo as useMemo76 } from "react";
...
var WarningIndicatorButton = ({ setShowWarning, showWarning, warningCount }) => {
  ...
  return /* @__PURE__ */ jsxs66("button", {
    ...
    onClick,
    children: [
      /* @__PURE__ */ jsx135(WarningTriangle2, {
...
var DataEditor = ({
  ...
  const [mode, setMode] = useState47("schema");
  const [showWarning, setShowWarningWithoutPersistance] = useState47(() => getPersistedShowWarningState());
  const { updateCompositionDefaultProps } = useContext35(Internals31.CompositionSetters);
  const inJSONEditor = mode === "json";
  const serializedJSON = useMemo77(() => {
    if (!inJSONEditor) {
      return null;
    }
  ...
  const zodValidationResult = useMemo77(() => {
    if (schema === "no-zod") {
      return "no-zod";
    }
    if (schema === "no-schema") {
  ...
  const setShowWarning = useCallback66((val) => {
  ...
  const canSaveDefaultProps = useMemo77(() => {
  ...
  const { fastRefreshes } = useContext35(Internals31.NonceContext);
  const checkIfCanSaveDefaultProps = useCallback66(async () => {
    try {
  ...
  const { previewServerState, subscribeToEvent } = useContext35(StudioServerConnectionCtx);
  useEffect41(() => {
  ...
  if (schema === "no-zod") {
    return /* @__PURE__ */ jsx136(ZodNotInstalled, {});
  }
  if (schema === "no-schema") {
    return /* @__PURE__ */ jsx136(NoSchemaDefined, {});
  }
  if (!z) {
    throw new Error("expected zod");
  }
  ...
  if (!unresolvedComposition.defaultProps) {
    return /* @__PURE__ */ jsx136(NoDefaultProps, {});
  }
  return /* @__PURE__ */ jsxs67("div", {
    style: outer,
    children: [
      /* @__PURE__ */ jsxs67("div", {
        ...
        children: [
          /* @__PURE__ */ jsxs67("div", {
            style: tabWrapper,
            children: [
              /* @__PURE__ */ jsx136(SegmentedControl, {
                items: modeItems,
                needsWrapping: false
              }),
              /* @__PURE__ */ jsx136(Flex, {}),
              warnings.length > 0 ? /* @__PURE__ */ jsx136(WarningIndicatorButton, {
                setShowWarning,
                showWarning,
          ...
          showWarning && warnings.length > 0 ? warnings.map((warning) => /* @__PURE__ */ jsxs67(React89.Fragment, {
            children: [
              /* @__PURE__ */ jsx136(Spacing, {
                y: 1
              }),
              /* @__PURE__ */ jsx136(ValidationMessage, {
                message: warning,
                align: "flex-start",
                type: "warning"
              })
      ...
      mode === "schema" ? /* @__PURE__ */ jsx136(SchemaEditor, {
      ...
      }) : /* @__PURE__ */ jsx136(RenderModalJSONPropsEditor, {
        value: defaultProps ?? {},
        setValue: setDefaultProps,
        onSave: onUpdate,
        showSaveButton,
...
import React99, { useContext as useContext41, useEffect as useEffect43, useMemo as useMemo84 } from "react";
...
var RenderQueueCopyToClipboard = ({ job }) => {
  const renderCopyAction = useCallback67((color) => {
    return /* @__PURE__ */ jsx137(ClipboardIcon, {
      style: revealIconStyle2,
      color
    });
  }, []);
  const onClick = useCallback67(async (e) => {
    e.stopPropagation();
    try {
...
import { useCallback as useCallback68, useContext as useContext36 } from "react";
...
import React92, { useCallback as useCallback70, useContext as useContext37 } from "react";
...
var RenderQueueItemStatus = ({ job }) => {
  ...
  const onPointerEnter = useCallback70(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback70(() => {
    setHovered(false);
  }, []);
  ...
  if (job.status === "running") {
    return /* @__PURE__ */ jsx141("button", {
      ...
      style: invisibleStyle,
      onClick,
      children: /* @__PURE__ */ jsx141(CircularProgress, {
...
import { useCallback as useCallback71, useMemo as useMemo79 } from "react";
...
var RenderQueueOpenInFinderItem = ({ job }) => {
  ...
  const renderAction = useCallback71((color) => {
    return /* @__PURE__ */ jsx142(ExpandedFolderIconSolid, {
      style: icon4,
      color
    });
  }, [icon4]);
...
import { useCallback as useCallback72, useContext as useContext38 } from "react";
...
import { useCallback as useCallback74, useContext as useContext39, useMemo as useMemo82 } from "react";
...
var RenderQueueRepeatItem = ({ job }) => {
  ...
  const isMobileLayout = useMobileLayout();
  const { setSidebarCollapsedState } = useContext39(SidebarContext);
...
var RenderQueueItem = ({ job, selected }) => {
  ...
  const { setCanvasContent } = useContext40(Internals32.CompositionSetters);
  const onPointerEnter = useCallback75(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback75(() => {
    setHovered(false);
  }, []);
  const isHoverable = job.status === "done";
  const containerStyle2 = useMemo83(() => {
    return {
      ...container29,
      backgroundColor: getBackgroundFromHoverState({
  ...
  const scrollCurrentIntoView = useCallback75(() => {
  ...
  return /* @__PURE__ */ jsxs68(Row, {
    ...
    children: [
      /* @__PURE__ */ jsx147(RenderQueueItemStatus, {
        job
      }),
      ...
      /* @__PURE__ */ jsxs68("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx147("div", {
            style: subtitle2,
            children: job.status === "done" ? /* @__PURE__ */ jsx147(RenderQueueOutputName, {
              job
            }) : job.status === "failed" ? /* @__PURE__ */ jsx147(RenderQueueError, {
              job
            }) : job.status === "running" ? /* @__PURE__ */ jsx147(RenderQueueProgressMessage, {
              job
            }) : null
          })
        ]
      ...
      supportsCopyingToClipboard(job) ? /* @__PURE__ */ jsx147(RenderQueueCopyToClipboard, {
        job
      }) : null,
      job.status === "done" || job.status === "failed" ? /* @__PURE__ */ jsx147(RenderQueueRepeatItem, {
        job
      }) : null,
      job.status === "running" ? /* @__PURE__ */ jsx147(RenderQueueCancelButton, {
        job
      }) : /* @__PURE__ */ jsx147(RenderQueueRemoveItem, {
        job
      }),
      job.status === "done" ? /* @__PURE__ */ jsx147(RenderQueueOpenInFinderItem, {
        job
      }) : null
    ]
  });
...
// src/components/RenderQueue/index.tsx
import { jsx as jsx148, jsxs as jsxs69 } from "react/jsx-runtime";
var separatorStyle = {
  borderBottom: `1px solid ${BORDER_COLOR}`
};
...
var RenderQueue = () => {
  const connectionStatus = useContext41(StudioServerConnectionCtx).previewServerState.type;
  ...
  return /* @__PURE__ */ jsx148("div", {
    ...
    children: jobs.map((j, index) => {
      return /* @__PURE__ */ jsx148("div", {
        ...
        children: /* @__PURE__ */ jsx148(RenderQueueItem, {
...
import { useContext as useContext42, useMemo as useMemo85 } from "react";
import { Internals as Internals34 } from "remotion";
import { jsx as jsx149, jsxs as jsxs70, Fragment as Fragment20 } from "react/jsx-runtime";
var row3 = {
  display: "flex",
  flexDirection: "row",
  fontSize: 14,
...
var RendersTab = ({ selected, onClick }) => {
  ...
  const { canvasContent } = useContext42(Internals34.CompositionManager);
  const failedJobs = jobs.filter((j) => j.status === "failed").length;
  const jobCount = jobs.length;
  const isActuallySelected = useMemo85(() => {
    if (!canvasContent || canvasContent.type !== "composition") {
      return true;
    }
    return selected;
  }, [canvasContent, selected]);
  const badgeStyle = useMemo85(() => {
    return {
      ...badge,
...
// src/components/OptionsPanel.tsx
import { jsx as jsx150, jsxs as jsxs71 } from "react/jsx-runtime";
...
var OptionsPanel = ({ readOnlyStudio }) => {
  const { props, updateProps, resetUnsaved } = useContext43(Internals35.EditorPropsContext);
  const [saving, setSaving] = useState49(false);
  const isMobileLayout = useMobileLayout();
  const container30 = useMemo86(() => ({
    height: "100%",
    width: "100%",
    display: "flex",
  ...
  const [panel, setPanel] = useState49(() => getSelectedPanel2(readOnlyStudio));
  const onPropsSelected = useCallback76(() => {
    setPanel("input-props");
    persistSelectedOptionsSidebarPanel2("input-props");
  }, []);
  const onRendersSelected = useCallback76(() => {
    setPanel("renders");
  ...
  const { compositions, canvasContent } = useContext43(Internals35.CompositionManager);
  const composition = useMemo86(() => {
    if (canvasContent === null || canvasContent.type !== "composition") {
      return null;
    }
  ...
  const setDefaultProps = useCallback76((newProps) => {
    if (composition === null) {
      return;
    }
    window.remotion_ignoreFastRefreshUpdate = null;
  ...
  const currentDefaultProps = useMemo86(() => {
    if (composition === null) {
      return {};
    }
    return props[composition.id] ?? composition.defaultProps ?? {};
  }, [composition, props]);
  const unsavedChangesExist = useMemo86(() => {
  ...
  return /* @__PURE__ */ jsxs71("div", {
    ...
    children: [
        ...
        children: /* @__PURE__ */ jsxs71(Tabs, {
          children: [
            composition ? /* @__PURE__ */ jsxs71(Tab, {
              ...
              children: [
                "Props",
                unsavedChangesExist ? /* @__PURE__ */ jsx150(GlobalPropsEditorUpdateButton, {
                  compositionId: composition.id,
                  currentDefaultProps
                }) : null
              ]
            }) : null,
            readOnlyStudio ? null : /* @__PURE__ */ jsx150(RendersTab, {
      ...
      panel === `input-props` && composition ? /* @__PURE__ */ jsx150(DataEditor, {
        ...
        setSaving,
        readOnlyStudio
      }, composition.id) : readOnlyStudio ? null : /* @__PURE__ */ jsx150(RenderQueue, {})
    ]
  });
};

// src/components/PreviewToolbar.tsx
import { useContext as useContext50, useEffect as useEffect50, useRef as useRef26, useState as useState52 } from "react";
...
var CheckboardToggle = () => {
  const { checkerboard, setCheckerboard } = useContext44(CheckerboardContext);
...
var FpsCounter = ({ playbackSpeed }) => {
  ...
  const [marker, rerender] = useState50({});
  const [fps, setFps] = useState50(0);
...
import { useCallback as useCallback78, useContext as useContext45, useEffect as useEffect46 } from "react";
...
var FullScreenToggle = () => {
  const keybindings = useKeybinding();
  const { setSize } = useContext45(Internals37.PreviewSizeContext);
...
var MuteToggle = ({ muted, setMuted }) => {
  ...
  return /* @__PURE__ */ jsx155(ControlButton, {
    title: accessibilityLabel5,
    "aria-label": accessibilityLabel5,
    onClick,
    children: muted ? /* @__PURE__ */ jsx155(VolumeOffIcon, {}) : /* @__PURE__ */ jsx155(VolumeOnIcon, {})
  });
};

// src/components/PlayPause.tsx
import { PlayerInternals as PlayerInternals12 } from "@remotion/player";
import { useCallback as useCallback81, useEffect as useEffect47, useState as useState51 } from "react";
...
var Pause = (props) => /* @__PURE__ */ jsx157("svg", {
  ...props,
  "aria-hidden": "true",
  focusable: "false",
  "data-prefix": "fas",
...
var Play = (props) => /* @__PURE__ */ jsx158("svg", {
  ...props,
  "aria-hidden": "true",
  focusable: "false",
  "data-prefix": "fas",
...
// src/components/PlayPause.tsx
import { jsx as jsx161, jsxs as jsxs73, Fragment as Fragment21 } from "react/jsx-runtime";
var backStyle = {
  height: 18,
  color: "white"
};
...
var PlayPause = ({ playbackRate, loop, bufferStateDelayInMilliseconds }) => {
  ...
  const [showBufferIndicator, setShowBufferState] = useState51(false);
  const {
    playing,
    play,
    pause,
  ...
  const onEnter = useCallback81((e) => {
    if (playing) {
      e.preventDefault();
      pauseAndReturnToPlayStart();
    }
  }, [pauseAndReturnToPlayStart, playing]);
  const onArrowLeft = useCallback81((e) => {
    e.preventDefault();
    if (e.altKey) {
      seek(0);
      ensureFrameIsInViewport({
  ...
  const onArrowRight = useCallback81((e) => {
    if (e.altKey) {
  ...
  const oneFrameBack = useCallback81(() => {
    frameBack(1);
  }, [frameBack]);
  const oneFrameForward = useCallback81(() => {
    frameForward(1);
  }, [frameForward]);
  const jumpToStart = useCallback81(() => {
    seek(inFrame ?? 0);
  }, [seek, inFrame]);
  const jumpToEnd = useCallback81(() => {
  ...
  return /* @__PURE__ */ jsxs73(Fragment21, {
    children: [
      /* @__PURE__ */ jsx161(ControlButton, {
        ...
        disabled: !videoConfig || isFirstFrame,
        onClick: jumpToStart,
        children: /* @__PURE__ */ jsx161(JumpToStart, {
          style: backStyle
        })
      }),
      /* @__PURE__ */ jsx161(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx161(StepBack, {
      ...
      /* @__PURE__ */ jsx161(ControlButton, {
        ...
        children: playing ? showBufferIndicator ? /* @__PURE__ */ jsx161(PlayerInternals12.BufferingIndicator, {
          type: "studio"
        }) : /* @__PURE__ */ jsx161(Pause, {
          style: iconButton
        }) : /* @__PURE__ */ jsx161(Play, {
          style: iconButton
        })
      }),
      /* @__PURE__ */ jsx161(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx161(StepForward, {
          style: forwardBackStyle
        })
      })
    ]
...
var PlaybackKeyboardShortcutsManager = ({ setPlaybackRate }) => {
  ...
  const onKKey = useCallback82(() => {
    setPlaybackRate(1);
    pause();
  }, [pause, setPlaybackRate]);
  const onLKey = useCallback82(() => {
    setPlaybackRate((prevPlaybackRate) => {
      if (!playing) {
        return 1;
      }
...
import { useContext as useContext46, useEffect as useEffect49 } from "react";
...
var PlaybackRatePersistor = () => {
  const { setPlaybackRate, playbackRate } = useContext46(Internals39.Timeline.TimelineContext);
  useEffect49(() => {
...
import { useContext as useContext47, useMemo as useMemo88 } from "react";
...
var PlaybackRateSelector = ({ playbackRate, setPlaybackRate }) => {
  const { canvasContent } = useContext47(Internals40.CompositionManager);
  const isStill = useIsStill();
  ...
  const items = useMemo88(() => {
    ...
    const values = commonPlaybackRates.map((newPlaybackRate) => {
      return {
        ...
        keyHint: null,
        leftItem: String(playbackRate) === String(newPlaybackRate) ? /* @__PURE__ */ jsx162(Checkmark, {}) : null,
        subMenu: null,
        quickSwitcherLabel: null
      };
    });
  ...
  return /* @__PURE__ */ jsx162("div", {
    style: style9,
    "aria-label": accessibilityLabel5,
    children: /* @__PURE__ */ jsx162(Combobox, {
      title: accessibilityLabel5,
      style: comboStyle2,
...
import { useCallback as useCallback83, useContext as useContext48, useMemo as useMemo89 } from "react";
...
var RenderButton = () => {
  ...
  const connectionStatus = useContext48(StudioServerConnectionCtx).previewServerState.type;
  ...
  const { props } = useContext48(Internals41.EditorPropsContext);
  ...
  return /* @__PURE__ */ jsx163(Button, {
    ...
    children: /* @__PURE__ */ jsxs74(Row, {
      align: "center",
      children: [
        /* @__PURE__ */ jsx163(RenderIcon, {
          svgProps: iconStyle4
        }),
        /* @__PURE__ */ jsx163(Spacing, {
          x: 1
        }),
        /* @__PURE__ */ jsx163("span", {
          style: label7,
          children: "Render"
        })
      ]
...
import { useCallback as useCallback84, useContext as useContext49 } from "react";
...
// src/components/Timeline/TimelineZoomControls.tsx
import { jsx as jsx165, jsxs as jsxs75 } from "react/jsx-runtime";
var container30 = {
  color: "black",
  flexDirection: "row",
  display: "flex",
...
var TimelineZoomControls = () => {
  const { canvasContent } = useContext49(Internals42.CompositionManager);
  const { setZoom, zoom: zoomMap } = useContext49(TimelineZoomCtx);
  const { tabIndex } = useZIndex();
  const onMinusClicked = useCallback84(() => {
    if (canvasContent === null || canvasContent.type !== "composition") {
      return;
    }
    setZoom(canvasContent.compositionId, (z) => Math.max(TIMELINE_MIN_ZOOM, z - 0.2));
  }, [canvasContent, setZoom]);
  const onPlusClicked = useCallback84(() => {
    if (canvasContent === null || canvasContent.type !== "composition") {
      return;
    }
    setZoom(canvasContent.compositionId, (z) => Math.min(TIMELINE_MAX_ZOOM, z + 0.2));
  }, [canvasContent, setZoom]);
  const onChange = useCallback84((e) => {
    if (canvasContent === null || canvasContent.type !== "composition") {
      return;
    }
  ...
  return /* @__PURE__ */ jsxs75("div", {
    ...
    children: [
      /* @__PURE__ */ jsx165(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx165(Minus, {
          style: iconStyle4
        })
      }),
...
// src/components/PreviewToolbar.tsx
import { jsx as jsx166, jsxs as jsxs76, Fragment as Fragment22 } from "react/jsx-runtime";
var container31 = {
  display: "flex",
  justifyContent: "center",
...
var PreviewToolbar = ({ readOnlyStudio, bufferStateDelayInMilliseconds }) => {
  const { playbackRate, setPlaybackRate } = useContext50(Internals43.Timeline.TimelineContext);
  const { mediaMuted } = useContext50(Internals43.MediaVolumeContext);
  const { setMediaMuted } = useContext50(Internals43.SetMediaVolumeContext);
  ...
  const isStill = useIsStill();
  const [loop, setLoop] = useState52(loadLoopOption());
  const isFullscreenSupported = checkFullscreenSupport();
  const isMobileLayout = useMobileLayout();
  useEffect50(() => {
  ...
  return /* @__PURE__ */ jsxs76("div", {
    ...
    children: [
        ...
        children: [
          /* @__PURE__ */ jsxs76("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx166(TimelineZoomControls, {})
            ]
          }),
          /* @__PURE__ */ jsx166(Flex, {}),
          /* @__PURE__ */ jsx166(SizeSelector, {}),
          isStill || isVideoComposition ? /* @__PURE__ */ jsx166(PlaybackRateSelector, {
            setPlaybackRate,
            playbackRate
          }) : null
        ]
      ...
      isVideoComposition ? /* @__PURE__ */ jsxs76(Fragment22, {
        children: [
          /* @__PURE__ */ jsx166(Spacing, {
            x: 2
          }),
          /* @__PURE__ */ jsx166(PlayPause, {
            bufferStateDelayInMilliseconds,
            loop,
            playbackRate
          }),
          ...
          /* @__PURE__ */ jsx166(LoopToggle, {
            loop,
            setLoop
          }),
          /* @__PURE__ */ jsx166(MuteToggle, {
            muted: mediaMuted,
          ...
          /* @__PURE__ */ jsx166(TimelineInOutPointToggle, {}),
          /* @__PURE__ */ jsx166(Spacing, {
            x: 2
          })
        ]
      }) : null,
      /* @__PURE__ */ jsx166(CheckboardToggle, {}),
      /* @__PURE__ */ jsx166(Spacing, {
        x: 1
      }),
      isFullscreenSupported && /* @__PURE__ */ jsx166(FullScreenToggle, {}),
      /* @__PURE__ */ jsx166(Flex, {}),
      ...
      /* @__PURE__ */ jsxs76("div", {
        ...
        children: [
          /* @__PURE__ */ jsx166(Flex, {}),
          !isMobileLayout && /* @__PURE__ */ jsx166(FpsCounter, {
            playbackSpeed: playbackRate
          }),
          /* @__PURE__ */ jsx166(Spacing, {
            x: 2
          }),
          readOnlyStudio ? null : /* @__PURE__ */ jsx166(RenderButton, {}),
          /* @__PURE__ */ jsx166(Spacing, {
            x: 1.5
          })
        ]
      }),
      /* @__PURE__ */ jsx166(PlaybackKeyboardShortcutsManager, {
        setPlaybackRate
      }),
      /* @__PURE__ */ jsx166(PlaybackRatePersistor, {}),
      /* @__PURE__ */ jsx166("div", {
...
import { useMemo as useMemo90, useRef as useRef27, useState as useState53 } from "react";
...
var SplitterContainer = ({ orientation, children, defaultFlex, maxFlex, minFlex, id }) => {
  ...
  const [flexValue, setFlexValue] = useState53(initialTimelineFlex ?? defaultFlex);
  const ref = useRef27(null);
  const isDragging = useRef27(false);
  const value = useMemo90(() => {
    return {
      flexValue,
      ref,
      setFlexValue,
  ...
  return /* @__PURE__ */ jsx167(SplitterContext.Provider, {
    value,
...
import { useContext as useContext51, useMemo as useMemo91 } from "react";
import { interpolateColors, random } from "remotion";
import { jsx as jsx168, jsxs as jsxs77, Fragment as Fragment23 } from "react/jsx-runtime";
...
import { useContext as useContext52, useEffect as useEffect51, useRef as useRef28, useState as useState54 } from "react";
...
var SplitterHandle = ({ allowToCollapse, onCollapse }) => {
  const context = useContext52(SplitterContext);
  if (!context) {
    throw new Error("Cannot find splitter context");
  }
  const [lastPointerUp, setLastPointerUp] = useState54(() => Date.now());
...
// src/components/TopPanel.tsx
import { jsx as jsx170, jsxs as jsxs78 } from "react/jsx-runtime";
var container32 = {
  height: "100%",
  width: "100%",
  display: "flex",
...
var useResponsiveSidebarStatus = () => {
  const { sidebarCollapsedStateLeft } = useContext53(SidebarContext);
  const responsiveLeftStatus = useBreakpoint(1200) ? "collapsed" : "expanded";
  const actualStateLeft = useMemo92(() => {
...
var TopPanel = ({ readOnlyStudio, onMounted, drawRef: drawRef2, bufferStateDelayInMilliseconds }) => {
  ...
  const actualStateRight = useMemo92(() => {
    ...
    children: [
      /* @__PURE__ */ jsx170("div", {
        ...
        children: /* @__PURE__ */ jsxs78(SplitterContainer, {
          ...
          orientation: "vertical",
          children: [
            actualStateLeft === "expanded" ? isMobileLayout ? /* @__PURE__ */ jsx170(MobilePanel, {
              onClose: onCollapseLeft,
              children: /* @__PURE__ */ jsx170(ExplorerPanel, {
                readOnlyStudio
              })
            }) : /* @__PURE__ */ jsx170(SplitterElement, {
              sticky: null,
              type: "flexer",
              children: /* @__PURE__ */ jsx170(ExplorerPanel, {
                readOnlyStudio
            ...
            actualStateLeft === "expanded" ? /* @__PURE__ */ jsx170(SplitterHandle, {
                ...
                children: [
                  /* @__PURE__ */ jsx170(SplitterElement, {
                    ...
                    children: /* @__PURE__ */ jsx170("div", {
                      ...
                      children: /* @__PURE__ */ jsx170(CanvasIfSizeIsAvailable, {})
                    })
                  }),
                  actualStateRight === "expanded" ? /* @__PURE__ */ jsx170(SplitterHandle, {
                    allowToCollapse: "right",
                    onCollapse: onCollapseRight
                  }) : null,
                  actualStateRight === "expanded" ? isMobileLayout ? /* @__PURE__ */ jsx170(MobilePanel, {
                    onClose: onCollapseRight,
                    children: /* @__PURE__ */ jsx170(OptionsPanel, {
                      readOnlyStudio
                    })
                  }) : /* @__PURE__ */ jsx170(SplitterElement, {
                    sticky: null,
      ...
      /* @__PURE__ */ jsx170(PreviewToolbar, {
        bufferStateDelayInMilliseconds,
        readOnlyStudio
      }),
      /* @__PURE__ */ jsx170(CurrentCompositionKeybindings, {
        readOnlyStudio
      }),
      /* @__PURE__ */ jsx170(TitleUpdater, {})
    ]
  });
};

// src/components/SidebarCollapserControls.tsx
import { jsx as jsx171, jsxs as jsxs79, Fragment as Fragment24 } from "react/jsx-runtime";
var style9 = {
  width: 16,
  height: 16,
  minWidth: 16,
...
var SidebarCollapserControls = () => {
  const { setSidebarCollapsedState, sidebarCollapsedStateRight } = useContext54(SidebarContext);
  const keybindings = useKeybinding();
  const leftSidebarStatus = useResponsiveSidebarStatus();
  const leftIcon = useCallback86((color) => {
    return {
      width: "35%",
      height: "100%",
  ...
  const rightIcon = useCallback86((color) => {
    return {
      width: "35%",
      height: "100%",
      right: 0,
  ...
  const toggleLeft = useCallback86(() => {
    setSidebarCollapsedState({
      left: (s) => {
        if (s === "responsive") {
  ...
  const toggleRight = useCallback86(() => {
    setSidebarCollapsedState({
      right: (s) => s === "collapsed" ? "expanded" : "collapsed",
      left: null
    });
  }, [setSidebarCollapsedState]);
  const toggleBoth = useCallback86(() => {
  ...
  const colorStyle = useCallback86((color) => {
    return {
      ...style9,
      color
    };
  }, []);
  const toggleLeftAction = useCallback86((color) => {
    return /* @__PURE__ */ jsx171("div", {
      style: colorStyle(color),
      title: toggleLeftTooltip,
      children: /* @__PURE__ */ jsx171("div", {
        style: leftIcon(color)
      })
    });
  }, [colorStyle, leftIcon, toggleLeftTooltip]);
  const toggleRightAction = useCallback86((color) => {
    return /* @__PURE__ */ jsx171("div", {
      style: colorStyle(color),
...
var UpdateCheck = () => {
  const [info, setInfo] = useState55(null);
  const { setSelectedModal } = useContext55(ModalsContext);
  const { tabIndex } = useZIndex();
  const [knownBugs, setKnownBugs] = useState55(null);
  const hasKnownBugs = useMemo93(() => {
    return knownBugs && knownBugs.length > 0;
  }, [knownBugs]);
  const checkForUpdates = useCallback87(() => {
  ...
  const checkForBugs = useCallback87(() => {
    const controller = new AbortController;
  ...
  const dynButtonStyle = useMemo93(() => {
    return {
      ...buttonStyle4,
  ...
  return /* @__PURE__ */ jsx172("button", {
    ...
    children: hasKnownBugs ? "Bugfixes available" : /* @__PURE__ */ jsx172("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      style: {
        height: 16,
        width: 16
...
var MenuToolbar = ({ readOnlyStudio }) => {
  const [selected, setSelected] = useState56(null);
  const mobileLayout = useMobileLayout();
  const fixedWidthRight = useMemo94(() => {
    return {
  ...
  const fixedWidthLeft = useMemo94(() => {
    return {
  ...
  const itemClicked = useCallback88((itemId) => {
    setSelected(itemId);
  }, [setSelected]);
  const itemHovered = useCallback88((itemId) => {
    if (selected) {
      setSelected(itemId);
    }
  }, [selected, setSelected]);
  const closeMenu = useCallback88(() => {
    setSelected(null);
  }, []);
  const structure = useMenuStructure(closeMenu, readOnlyStudio);
  const menus = useMemo94(() => {
    return structure.map((s) => s.id);
  }, [structure]);
  const onPreviousMenu = useCallback88(() => {
    setSelected((s) => {
      if (s === null) {
        return null;
      }
  ...
  const onNextMenu = useCallback88(() => {
    setSelected((s) => {
      if (s === null) {
        return null;
      }
  ...
  const onItemQuit = useCallback88(() => {
    setSelected(null);
  }, [setSelected]);
  return /* @__PURE__ */ jsxs80(Row, {
    ...
    children: [
      /* @__PURE__ */ jsxs80("div", {
        ...
        children: [
          structure.map((s) => {
            return /* @__PURE__ */ jsx173(MenuItem, {
          ...
          readOnlyStudio ? null : /* @__PURE__ */ jsx173(UpdateCheck, {})
        ]
      }),
      /* @__PURE__ */ jsx173("div", {
        style: flex2
      }),
      /* @__PURE__ */ jsx173(MenuBuildIndicator, {}),
      /* @__PURE__ */ jsx173("div", {
        style: flex2
      }),
      /* @__PURE__ */ jsx173("div", {
        style: fixedWidthRight,
        children: /* @__PURE__ */ jsx173(SidebarCollapserControls, {})
      }),
...
import { useContext as useContext64, useMemo as useMemo105 } from "react";
...
import { createRef as createRef9, useContext as useContext56 } from "react";
import { Internals as Internals44 } from "remotion";
import { jsx as jsx174, jsxs as jsxs82, Fragment as Fragment25 } from "react/jsx-runtime";
var areaHighlight = {
  position: "absolute",
...
var TimelineInOutPointer = () => {
  ...
  return /* @__PURE__ */ jsxs82(Fragment25, {
    children: [
      inFrame !== null && /* @__PURE__ */ jsx174("div", {
        ref: inMarkerAreaRef,
        style: {
          ...areaHighlight,
          left: 0,
      ...
      outFrame !== null && /* @__PURE__ */ jsx174("div", {
...
import { createRef as createRef10, useContext as useContext57, useMemo as useMemo95 } from "react";
...
var TimelineInOutPointerHandle = ({
  ...
  return /* @__PURE__ */ jsx175(InnerTimelineInOutPointerHandle, {
    atFrame,
    dragging,
    timelineWidth,
    type
...
var TimelineDragHandler = () => {
  ...
  const containerStyle2 = useMemo96(() => {
    if (!canvasContent || canvasContent.type !== "composition") {
      return {};
    }
    const zoom = zoomMap[canvasContent.compositionId] ?? TIMELINE_MIN_ZOOM;
  ...
  return /* @__PURE__ */ jsx176("div", {
    ref: sliderAreaRef,
    style: containerStyle2,
    children: video ? /* @__PURE__ */ jsx176(Inner2, {}) : null
  });
};
var Inner2 = () => {
  ...
  const [inOutDragging, setInOutDragging] = useState57({
    dragging: false
  });
  const timelineWidth = useContext58(TimelineWidthContext);
  const get = useCallback89((frame2) => {
    if (timelineWidth === null) {
  ...
  const { inFrame, outFrame } = useTimelineInOutFramePosition();
  const { setInAndOutFrames } = useTimelineSetInOutFramePosition();
  const [dragging, setDragging] = useState57({
    dragging: false
  });
  ...
  const onPointerMoveScrubbing = useCallback89((e) => {
    if (!videoConfig) {
      return;
    }
  ...
  const onPointerMoveInOut = useCallback89((e) => {
    if (!videoConfig) {
      return;
    }
  ...
  const onPointerUpScrubbing = useCallback89((e) => {
    stopInterval();
    if (!videoConfig) {
      return;
    }
  ...
  const onPointerUpInOut = useCallback89((e) => {
    if (!videoConfig) {
      return;
    }
    if (!inOutDragging.dragging) {
  ...
  const outContextMenu = useMemo96(() => {
    return [
      {
        id: "hide-out",
        keyHint: null,
  ...
  return /* @__PURE__ */ jsxs83("div", {
    ...
    children: [
      ...
      inFrame !== null && /* @__PURE__ */ jsx176(ContextMenu, {
        values: inContextMenu,
        children: /* @__PURE__ */ jsx176(TimelineInOutPointerHandle, {
          type: "in",
          atFrame: inFrame,
          dragging: inOutDragging.dragging === "in"
        })
      }),
      outFrame !== null && /* @__PURE__ */ jsx176(ContextMenu, {
...
import { useCallback as useCallback92, useContext as useContext60, useMemo as useMemo98 } from "react";
import { Internals as Internals46 } from "remotion";

// src/components/Timeline/TimelineLayerEye.tsx
import { useCallback as useCallback90 } from "react";
...
var TimelineLayerEye = ({ onInvoked, hidden, type }) => {
  const renderAction = useCallback90((color) => {
    if (hidden) {
      return null;
    }
    if (type === "speaker") {
      return /* @__PURE__ */ jsx177("svg", {
        viewBox: "0 0 10 14",
        fill: "none",
        style: speakerIcon,
        children: /* @__PURE__ */ jsx177("path", {
  ...
  const onPointerDown = useCallback90((e) => {
    if (e.button !== 0) {
      return;
    }
  ...
  const onPointerEnter = useCallback90(() => {
    if (layerPointedDown) {
      onInvoked(layerPointedDown);
    }
  }, [onInvoked]);
...
// src/components/Timeline/TimelineStack/index.tsx
import { jsx as jsx178, jsxs as jsxs84, Fragment as Fragment26 } from "react/jsx-runtime";
...
var TimelineStack = ({ isCompact, sequence }) => {
  const [originalLocation, setOriginalLocation] = useState58(null);
  const [stackHovered, setStackHovered] = useState58(false);
  const [titleHovered, setTitleHovered] = useState58(false);
  const [opening, setOpening] = useState58(false);
  const selectAsset = useSelectAsset();
  const connectionStatus = useContext59(StudioServerConnectionCtx).previewServerState.type;
  const assetPath = useMemo97(() => {
  ...
  const navigateToAsset = useCallback91((asset) => {
    selectAsset(asset);
    pushUrl(`/assets/${asset}`);
  }, [selectAsset]);
  const openEditor = useCallback91(async (location2) => {
  ...
  const onClickTitle = useCallback91(() => {
    if (!titleHoverable) {
      return null;
    }
    if (assetPath) {
  ...
  const onClickStack = useCallback91(() => {
    if (!originalLocation) {
      return;
    }
    if (canOpenInEditor) {
  ...
  const onStackPointerEnter = useCallback91(() => {
    setStackHovered(true);
  }, []);
  const onStackPointerLeave = useCallback91(() => {
    setStackHovered(false);
  }, []);
  const onTitlePointerEnter = useCallback91(() => {
    setTitleHovered(true);
  }, []);
  const onTitlePointerLeave = useCallback91(() => {
  ...
  return /* @__PURE__ */ jsxs84(Fragment26, {
    children: [
      ...
      isCompact || !originalLocation ? null : /* @__PURE__ */ jsx178("div", {
...
var TimelineListItem = ({ nestedDepth, sequence, isCompact }) => {
  const { hidden, setHidden } = useContext60(Internals46.SequenceVisibilityToggleContext);
  const padder = useMemo98(() => {
    return {
      width: Number(SPACING * 1.5) * nestedDepth,
      flexShrink: 0
    };
  }, [nestedDepth]);
  const isItemHidden = useMemo98(() => {
    return hidden[sequence.id] ?? false;
  }, [hidden, sequence.id]);
  const onToggleVisibility = useCallback92((type) => {
    setHidden((prev) => {
      return {
        ...prev,
  ...
  return /* @__PURE__ */ jsxs85("div", {
    style: outer2,
    children: [
      /* @__PURE__ */ jsx179(TimelineLayerEye, {
      ...
      sequence.parent && nestedDepth > 0 ? /* @__PURE__ */ jsx179("div", {
        style: space
      }) : null,
      /* @__PURE__ */ jsx179(TimelineStack, {
        sequence,
        isCompact
      })
    ]
...
import { useContext as useContext61, useEffect as useEffect58, useMemo as useMemo99, useRef as useRef31 } from "react";
...
import { Internals as Internals47, useCurrentFrame } from "remotion";
import { jsx as jsx180, jsxs as jsxs86 } from "react/jsx-runtime";
var text = {
  color: "white",
  display: "flex",
  flexDirection: "row",
...
var TimeValue = () => {
  ...
  const config = Internals47.useUnsafeVideoConfig();
  const isStill = useIsStill();
  const { seek, play, pause, toggle } = PlayerInternals17.usePlayer();
  const keybindings = useKeybinding();
  const ref = useRef30(null);
  const onTextChange = useCallback93((newVal) => {
    seek(parseInt(newVal, 10));
  }, [seek]);
  const onValueChange = useCallback93((val) => {
    seek(val);
  }, [seek]);
  useImperativeHandle12(Internals47.timeValueRef, () => ({
    goToFrame: () => {
      ref.current?.click();
    },
    seek,
  ...
  return /* @__PURE__ */ jsxs86("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx180(Flex, {}),
      /* @__PURE__ */ jsx180(InputDragger, {
        ref,
        value: frame2,
        onTextChange,
        onValueChange,
...
var TimelineTimePlaceholders = () => {
  return /* @__PURE__ */ jsx181("div", {
    style: timeValue,
    children: /* @__PURE__ */ jsx181(TimeValue, {})
  });
};
...
var TimelineTimeIndicators = () => {
  const sliderTrack = useContext61(TimelineWidthContext);
...
var Inner3 = ({ windowWidth, durationInFrames, fps }) => {
  ...
  return /* @__PURE__ */ jsx181("div", {
    ...
    children: ticks.map((t) => {
      return /* @__PURE__ */ jsx181("div", {
        style: t.style,
        children: t.showTime ? /* @__PURE__ */ jsx181("div", {
          style: tickLabel,
...
// src/components/Timeline/TimelineList.tsx
import { jsx as jsx182, jsxs as jsxs87 } from "react/jsx-runtime";
var container37 = {
  flex: 1,
  background: BACKGROUND
};
var TimelineList = ({ timeline }) => {
  ...
  return /* @__PURE__ */ jsxs87("div", {
    ...
    style: container37,
    children: [
      /* @__PURE__ */ jsx182(TimelineTimePadding, {}),
      timeline.map((track) => {
        return /* @__PURE__ */ jsx182("div", {
          children: /* @__PURE__ */ jsx182(TimelineListItem, {
...
import { useContext as useContext62, useEffect as useEffect59 } from "react";
...
var TimelinePlayCursorSyncer = () => {
  ...
  const timelineContext = useContext62(Internals49.Timeline.TimelineContext);
  const timelinePosition = Internals49.Timeline.useTimelinePosition();
  const { canvasContent } = useContext62(Internals49.CompositionManager);
  const { zoom: zoomMap } = useContext62(TimelineZoomCtx);
...
var TimelineScrollable = ({ children }) => {
  const containerStyle2 = useMemo100(() => {
    return {
      width: "100%",
      minHeight: "100%"
    };
...
import { useContext as useContext63, useMemo as useMemo103, useState as useState61 } from "react";
import { Internals as Internals51, useCurrentFrame as useCurrentFrame2 } from "remotion";
...
import { useEffect as useEffect60, useMemo as useMemo102, useRef as useRef33, useState as useState59 } from "react";
...
var AudioWaveform = ({
  ...
  const [metadata, setMetadata] = useState59(null);
  const [error, setError] = useState59(null);
  const mountState = useRef33({ isMounted: true });
  const vidConf = Internals50.useUnsafeVideoConfig();
  if (vidConf === null) {
  ...
  return /* @__PURE__ */ jsxs88("div", {
    ...
    children: [
      normalized.map((w) => {
        return /* @__PURE__ */ jsx185(AudioWaveformBar, {
          amplitude: w.amplitude * (typeof volume === "number" ? volume : 1)
        }, w.index);
      }),
      /* @__PURE__ */ jsx185("canvas", {
        ref: canvas,
        style: canvasStyle,
...
var LoopedIndicator = () => {
  return /* @__PURE__ */ jsxs89("div", {
    style: width,
    children: [
      /* @__PURE__ */ jsx186(AbsoluteFill3, {
        style: topContainer,
        children: /* @__PURE__ */ jsx186("div", {
          style: topLine
        })
      }),
      /* @__PURE__ */ jsx186(AbsoluteFill3, {
...
var LoopedTimelineIndicator = ({ loops }) => {
  return /* @__PURE__ */ jsx187(AbsoluteFill4, {
    style: row6,
    children: new Array(loops).fill(true).map((_l, i) => {
      return /* @__PURE__ */ jsxs90(React129.Fragment, {
        children: [
          /* @__PURE__ */ jsx187(Flex, {}),
          i === loops - 1 ? null : /* @__PURE__ */ jsx187(LoopedIndicator, {})
        ]
      }, i);
    })
  });
...
import { useEffect as useEffect61, useRef as useRef34, useState as useState60 } from "react";
...
var TimelineVideoInfo = ({ src }) => {
  ...
  const [videoMetadata, setVideoMetadata] = useState60(null);
  useEffect61(() => {
  ...
  return /* @__PURE__ */ jsx189("div", {
    style: containerStyle2,
    children: /* @__PURE__ */ jsx189("svg", {
      style: svgStyle2,
      role: "img",
      viewBox: "0 0 576 512",
      children: /* @__PURE__ */ jsx189("path", {
        style: pathStyle,
        fill: "currentColor",
...
var TimelineSequence = ({ s }) => {
  const windowWidth = useContext63(TimelineWidthContext);
  if (windowWidth === null) {
    return null;
  }
  return /* @__PURE__ */ jsx190(Inner4, {
    windowWidth,
    s
  });
};
var Inner4 = ({ s, windowWidth }) => {
  const [maxMediaDuration, setMaxMediaDuration] = useState61(Infinity);
  ...
  const { marginLeft, width: width2, premountWidth } = useMemo103(() => {
  ...
  return /* @__PURE__ */ jsxs91("div", {
    ...
    title: s.displayName,
    children: [
      premountWidth ? /* @__PURE__ */ jsx190("div", {
        style: {
          width: premountWidth,
          height: "100%",
      ...
      s.type === "audio" ? /* @__PURE__ */ jsx190(AudioWaveform, {
        src: s.src,
      ...
      s.type === "video" ? /* @__PURE__ */ jsx190(TimelineVideoInfo, {
        src: s.src
      }) : null,
      s.loopDisplay === undefined ? null : /* @__PURE__ */ jsx190(LoopedTimelineIndicator, {
        loops: s.loopDisplay.numberOfTimes
      }),
      s.type !== "audio" && s.type !== "video" && s.loopDisplay === undefined && (isInRange || isPremounting) ? /* @__PURE__ */ jsx190("div", {
        style: {
        ...
        children: /* @__PURE__ */ jsx190(TimelineSequenceFrame, {
...
var TimelineTracks = ({ timeline, hasBeenCut }) => {
  ...
  const timelineStyle = useMemo104(() => {
    return {
      ...timelineContent,
      width: 100 + "%"
    };
  ...
  return /* @__PURE__ */ jsxs92("div", {
    ...
    children: [
        ...
        children: [
          ...
          timeline.map((track) => {
            ...
            return /* @__PURE__ */ jsx191("div", {
              style: inner2,
              children: /* @__PURE__ */ jsx191(TimelineSequence, {
                s: track.sequence
              })
            }, track.sequence.id);
          })
      ...
      hasBeenCut ? /* @__PURE__ */ jsx191(MaxTimelineTracksReached, {}) : null
    ]
  });
};

// src/components/Timeline/Timeline.tsx
import { jsx as jsx192, jsxs as jsxs93 } from "react/jsx-runtime";
var container40 = {
  minHeight: "100%",
  flex: 1,
  display: "flex",
...
var Timeline = () => {
  const { sequences } = useContext64(Internals52.SequenceManager);
  const videoConfig = Internals52.useUnsafeVideoConfig();
  const timeline = useMemo105(() => {
    if (!videoConfig) {
      return [];
    }
  ...
  return /* @__PURE__ */ jsx192("div", {
    ...
    children: /* @__PURE__ */ jsx192(TimelineWidthProvider, {
      children: /* @__PURE__ */ jsx192("div", {
        ...
        children: /* @__PURE__ */ jsxs93(SplitterContainer, {
          ...
          minFlex: 0.15,
          children: [
            /* @__PURE__ */ jsx192(SplitterElement, {
              type: "flexer",
              sticky: /* @__PURE__ */ jsx192(TimelineTimePlaceholders, {}),
              children: /* @__PURE__ */ jsx192(TimelineList, {
                timeline: shown
              })
            }),
            /* @__PURE__ */ jsx192(SplitterHandle, {
              onCollapse: noop2,
            ...
            /* @__PURE__ */ jsx192(SplitterElement, {
              ...
              children: /* @__PURE__ */ jsxs93(TimelineScrollable, {
                children: [
                  /* @__PURE__ */ jsx192(TimelineTracks, {
                    timeline: shown,
                    hasBeenCut
                  }),
                  /* @__PURE__ */ jsx192(TimelineInOutPointer, {}),
                  /* @__PURE__ */ jsx192(TimelinePlayCursorSyncer, {}),
                  /* @__PURE__ */ jsx192(TimelineDragHandler, {}),
                  /* @__PURE__ */ jsx192(TimelineTimeIndicators, {}),
                  /* @__PURE__ */ jsx192(TimelineSlider, {})
                ]
              })
            })
          ]
...
// src/components/EditorContent.tsx
import { jsx as jsx193, jsxs as jsxs94, Fragment as Fragment27 } from "react/jsx-runtime";
var noop3 = () => {
  return;
};
var container41 = {
...
var EditorContent = ({ readOnlyStudio, children }) => {
  const isStill = useIsStill();
  const { canvasContent } = useContext65(Internals53.CompositionManager);
  const onlyTopPanel = canvasContent === null || isStill || canvasContent.type !== "composition";
  return /* @__PURE__ */ jsxs94("div", {
    style: container41,
    children: [
      /* @__PURE__ */ jsx193(InitialCompositionLoader, {}),
      /* @__PURE__ */ jsx193(MenuToolbar, {
        readOnlyStudio
      }),
      /* @__PURE__ */ jsxs94(SplitterContainer, {
        ...
        defaultFlex: 0.75,
        children: [
          /* @__PURE__ */ jsx193(SplitterElement, {
            sticky: null,
            type: "flexer",
            children
          }),
          onlyTopPanel ? null : /* @__PURE__ */ jsxs94(Fragment27, {
            children: [
              /* @__PURE__ */ jsx193(SplitterHandle, {
                allowToCollapse: "none",
                onCollapse: noop3
              }),
              /* @__PURE__ */ jsx193(SplitterElement, {
                sticky: null,
                type: "anti-flexer",
                children: /* @__PURE__ */ jsx193(Timeline, {})
              })
            ]
          })
        ]
...
import { useContext as useContext66, useEffect as useEffect62 } from "react";
var GlobalKeybindings = () => {
  const keybindings = useKeybinding();
  const { setSelectedModal } = useContext66(ModalsContext);
  const { setCheckerboard } = useContext66(CheckerboardContext);
  useEffect62(() => {
...
import React138, { useCallback as useCallback96, useContext as useContext69, useEffect as useEffect63 } from "react";
...
var InstallablePackageComp = ({ isInstalled, pkg, link, description }) => {
  return /* @__PURE__ */ jsxs95("div", {
    ...
    children: [
      ...
      " ",
      isInstalled ? /* @__PURE__ */ jsx194("span", {
        style: { opacity: 0.3, fontSize: "inherit" },
        children: "(installed)"
      }) : null,
      /* @__PURE__ */ jsx194("br", {}),
      /* @__PURE__ */ jsx194("span", {
...
import { useMemo as useMemo106 } from "react";
...
import { useCallback as useCallback94, useContext as useContext67 } from "react";
...
import { useCallback as useCallback95, useContext as useContext68 } from "react";
...
var ModalContainer = ({ children, onEscape, onOutsideClick }) => {
  return /* @__PURE__ */ jsx198("div", {
    ...
    role: "dialog",
    "aria-modal": "true",
    children: /* @__PURE__ */ jsx198(HigherZIndex, {
      onOutsideClick,
      onEscape,
      children: /* @__PURE__ */ jsx198("div", {
        style: panel,
        children
      })
    })
...
var DismissableModal = ({ children }) => {
  ...
  const onQuit = useCallback95(() => {
    setSelectedModal(null);
  }, [setSelectedModal]);
  return /* @__PURE__ */ jsx199(ModalContainer, {
...
var InstallPackageModal = ({ packageManager }) => {
  const [state, setState] = React138.useState({ type: "idle" });
  const [map, setMap] = React138.useState({});
  const { previewServerState: ctx } = useContext69(StudioServerConnectionCtx);
  const selectedPackages = Object.keys(map).filter((pkg) => map[pkg]);
  const onClick = useCallback96(async () => {
    if (state.type === "done") {
  ...
  return /* @__PURE__ */ jsxs97(DismissableModal, {
    children: [
      ...
      /* @__PURE__ */ jsx200("div", {
        ...
        }) : state.type === "restarting" ? /* @__PURE__ */ jsx200("div", {
          style: text2,
          ...
          children: Object.entries(installableMap).filter(([, install]) => install).map(([pkgShort]) => {
            ...
            return /* @__PURE__ */ jsxs97(Row, {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx200(InstallablePackageComp, {
                  description,
                  isInstalled,
                  link,
                  pkg
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs97(ModalButton, {
              ...
              children: [
                ...
                disabled ? null : /* @__PURE__ */ jsx200(ShortcutHint, {
                  keyToPress: "↵",
                  cmdOrCtrl: true
                })
              ]
...
import { useCallback as useCallback98, useContext as useContext72, useMemo as useMemo108 } from "react";

// src/components/RenderModal/ResolveCompositionBeforeModal.tsx
import React139, { useContext as useContext70, useEffect as useEffect64, useMemo as useMemo107 } from "react";
...
var ResolvedCompositionContext = React139.createContext(null);
var ResolveCompositionBeforeModal = ({ compositionId, children }) => {
  const resolved = Internals54.useResolvedVideoConfig(compositionId);
  const unresolvedContext = useContext70(Internals54.CompositionManager);
  const unresolved = unresolvedContext.compositions.find((c) => compositionId === c.id);
  useEffect64(() => {
    const { current } = Internals54.resolveCompositionsRef;
    if (!current) {
  ...
  if (!resolved || resolved.type === "loading") {
    return /* @__PURE__ */ jsx201(RunningCalculateMetadata, {});
  }
  if (resolved.type === "error") {
  ...
  return /* @__PURE__ */ jsx201(ResolvedCompositionContext.Provider, {
    value,
    children
  });
};
...
import { useCallback as useCallback97, useContext as useContext71, useEffect as useEffect65, useState as useState62 } from "react";
...
var CodemodFooter = ({
  ...
  const [submitting, setSubmitting] = useState62(false);
  const { setSelectedModal } = useContext71(ModalsContext);
  const [codemodStatus, setCanApplyCodemod] = useState62({
    type: "loading"
  });
  const [projectInfo, setProjectInfo] = useState62(null);
  useEffect65(() => {
    const controller = new AbortController;
  ...
  const getCanApplyCodemod = useCallback97(async (signal) => {
  ...
  return /* @__PURE__ */ jsxs100(Row, {
    align: "center",
    children: [
      /* @__PURE__ */ jsx203(CodemodDiffPreview, {
        status: codemodStatus
      }),
      /* @__PURE__ */ jsx203(Flex, {}),
...
// src/components/NewComposition/DeleteComposition.tsx
import { jsx as jsx204, jsxs as jsxs101, Fragment as Fragment28 } from "react/jsx-runtime";
var content3 = {
  padding: 16,
  fontSize: 14,
  flex: 1,
...
var DeleteComposition = ({ compositionId }) => {
  return /* @__PURE__ */ jsx204(DismissableModal, {
    children: /* @__PURE__ */ jsx204(ResolveCompositionBeforeModal, {
      compositionId,
      children: /* @__PURE__ */ jsx204(DeleteCompositionLoaded, {
        compositionId
      })
    })
  });
...
import { useCallback as useCallback100, useContext as useContext73, useMemo as useMemo109, useState as useState63 } from "react";
...
var validateCompositionName = (compName, compositions) => {
  if (!Internals55.isCompositionIdValid(compName)) {
    return Internals55.invalidCompositionErrorMessage;
  }
...
import { useCallback as useCallback99 } from "react";
import { jsx as jsx205, jsxs as jsxs102, Fragment as Fragment29 } from "react/jsx-runtime";
var NewCompDuration = ({ durationInFrames, setDurationInFrames }) => {
  const onDurationInFramesChanged = useCallback99((newValue) => {
    setDurationInFrames(Number(newValue));
  }, [setDurationInFrames]);
  const onDurationChangedDirectly = useCallback99((newVal) => {
...
// src/components/NewComposition/DuplicateComposition.tsx
import { jsx as jsx206, jsxs as jsxs103, Fragment as Fragment30 } from "react/jsx-runtime";
var content4 = {
  padding: 12,
  paddingRight: 12,
  flex: 1,
...
var DuplicateCompositionLoaded = ({ initialType }) => {
  ...
  const [initialCompType] = useState63(initialType);
  ...
  const [selectedFrameRate, setFrameRate] = useState63(resolved.result.fps);
  const { compositions } = useContext73(Internals56.CompositionManager);
  const [type, setType] = useState63(initialCompType);
  ...
  const [size4, setSize] = useState63(() => ({
    width: resolved.result.width,
    height: resolved.result.height
  }));
  const [durationInFrames, setDurationInFrames] = useState63(resolved.result.durationInFrames);
  const onTypeChanged = useCallback100((newType) => {
    setType(newType);
  }, []);
  const onWidthChanged = useCallback100((newValue) => {
    setSize((s) => {
      const { height } = s;
  ...
  const onWidthDirectlyChanged = useCallback100((newWidth) => {
    setSize((s) => {
      const { height } = s;
      return {
        height,
  ...
  const onHeightDirectlyChanged = useCallback100((newHeight) => {
    setSize((s) => {
  ...
  const onHeightChanged = useCallback100((newValue) => {
    setSize((s) => {
      const { width: width2 } = s;
  ...
  const onNameChange = useCallback100((e) => {
    setName(e.target.value);
  }, []);
  const onTextFpsChange = useCallback100((newFps) => {
    setFrameRate(Number(newFps));
  }, []);
  const onFpsChange = useCallback100((newFps) => {
    setFrameRate(newFps);
  }, []);
  ...
  const onSubmit = useCallback100((e) => {
    e.preventDefault();
  }, []);
      ...
      /* @__PURE__ */ jsxs103("form", {
        ...
        children: [
            ...
            children: [
              initialCompType === "composition" ? /* @__PURE__ */ jsxs103("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx206("div", {
                    style: rightRow,
                    children: /* @__PURE__ */ jsx206(Combobox, {
                      ...
                      children: [
                        ...
                        compNameErrMessage ? /* @__PURE__ */ jsxs103(Fragment30, {
                          children: [
                            ...
                            /* @__PURE__ */ jsx206(ValidationMessage, {
                              align: "flex-start",
              ...
              type === "composition" && hadDurationDefined ? /* @__PURE__ */ jsx206(NewCompDuration, {
                durationInFrames,
                setDurationInFrames
              }) : null,
              type === "composition" && hadFpsDefined ? /* @__PURE__ */ jsxs103("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx206("div", {
                    style: rightRow,
                    children: /* @__PURE__ */ jsx206(InputDragger, {
                      type: "number",
          ...
          /* @__PURE__ */ jsx206(ModalFooterContainer, {
            children: /* @__PURE__ */ jsx206(CodemodFooter, {
...
var DuplicateComposition = ({ compositionId, compositionType }) => {
  return /* @__PURE__ */ jsx206(DismissableModal, {
    children: /* @__PURE__ */ jsx206(ResolveCompositionBeforeModal, {
      compositionId,
      children: /* @__PURE__ */ jsx206(DuplicateCompositionLoaded, {
...
import { useCallback as useCallback101, useContext as useContext74, useMemo as useMemo110, useState as useState64 } from "react";
import { Internals as Internals57 } from "remotion";
import { jsx as jsx207, jsxs as jsxs104, Fragment as Fragment31 } from "react/jsx-runtime";
var content5 = {
  padding: 12,
  paddingRight: 12,
  flex: 1,
...
var RenameCompositionLoaded = () => {
  ...
  const [newId, setName] = useState64(() => {
    return resolved.result.id;
  });
  const onNameChange = useCallback101((e) => {
    setName(e.target.value);
  }, []);
      ...
      /* @__PURE__ */ jsxs104("form", {
        ...
        children: [
                    ...
                    children: [
                      ...
                      compNameErrMessage ? /* @__PURE__ */ jsxs104(Fragment31, {
                        children: [
                          ...
                          /* @__PURE__ */ jsx207(ValidationMessage, {
                            align: "flex-start",
                            message: compNameErrMessage,
                            type: "error"
                          })
          ...
          /* @__PURE__ */ jsx207(ModalFooterContainer, {
            children: /* @__PURE__ */ jsx207(CodemodFooter, {
...
var RenameComposition = ({ compositionId }) => {
  return /* @__PURE__ */ jsx207(DismissableModal, {
    children: /* @__PURE__ */ jsx207(ResolveCompositionBeforeModal, {
      compositionId,
      children: /* @__PURE__ */ jsx207(RenameCompositionLoaded, {})
    })
  });
};
                ...
                children: [
                  /* @__PURE__ */ jsxs105("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsx209("kbd", {
                        style: key4,
                        children: /* @__PURE__ */ jsx209(ShiftIcon, {})
                      }),
                      ...
                      /* @__PURE__ */ jsx209("kbd", {
                        style: key4,
                        children: /* @__PURE__ */ jsx209(ArrowLeft, {})
                      })
                    ]
                  }),
                  /* @__PURE__ */ jsx209("div", {
              ...
              /* @__PURE__ */ jsxs105(Row, {
                ...
                children: [
                  /* @__PURE__ */ jsx209("div", {
                    ...
                    children: /* @__PURE__ */ jsx209("kbd", {
                      style: key4,
                      children: /* @__PURE__ */ jsx209(ArrowRight, {})
                    })
                  }),
                  /* @__PURE__ */ jsx209("div", {
                    style: right2,
...
import { useEffect as useEffect66, useMemo as useMemo111, useRef as useRef35, useState as useState65 } from "react";
import { jsx as jsx211, jsxs as jsxs107, Fragment as Fragment32 } from "react/jsx-runtime";
var container46 = {
  paddingLeft: 16,
  paddingRight: 16,
  display: "flex",
...
var QuickSwitcherResult = ({ result, selected }) => {
  const [hovered, setIsHovered] = useState65(false);
  ...
  return /* @__PURE__ */ jsxs107("div", {
    ...
    children: [
      result.type === "composition" ? result.compositionType === "still" ? /* @__PURE__ */ jsx211(StillIcon, {
        color: selected ? "white" : LIGHT_TEXT,
        style: iconStyle6
      }) : /* @__PURE__ */ jsx211(FilmIcon, {
        color: selected ? "white" : LIGHT_TEXT,
        style: iconStyle6
      }) : null,
...
// src/components/QuickSwitcher/QuickSwitcherContent.tsx
import { jsx as jsx212, jsxs as jsxs108, Fragment as Fragment33 } from "react/jsx-runtime";
var input2 = {
  width: "100%"
};
var modeSelector = {
...
var QuickSwitcherContent = ({ initialMode, invocationTimestamp, readOnlyStudio }) => {
  const { compositions } = useContext75(Internals58.CompositionManager);
  const [state, setState] = useState66(() => {
    return {
    ...
    return fuzzySearch(actualQuery, compositions.map((c) => {
      return {
        ...
        onSelected: () => {
          ...
          Internals58.compositionSelectorRef.current?.expandComposition(c.id);
  ...
  const onArrowDown = useCallback102(() => {
    setState((s) => {
      return {
        ...s,
  ...
  const onArrowUp = useCallback102(() => {
    setState((s) => {
      return {
        ...s,
        selectedIndex: s.selectedIndex - 1
  ...
  const onTextChange = useCallback102((e) => {
  ...
  const onActionsSelected = useCallback102(() => {
    setState((s) => ({
  ...
  const onCompositionsSelected = useCallback102(() => {
    setState((s) => ({
      query: stripQuery(s.query),
      selectedIndex: 0
    }));
  ...
  const onDocSearchSelected = useCallback102(() => {
    setState((s) => ({
      query: `? ${stripQuery(s.query)}`,
      selectedIndex: 0
    }));
  ...
  const container47 = useMemo112(() => {
    return {
      width: showKeyboardShortcuts ? 800 : 500
    };
  }, [showKeyboardShortcuts]);
  const results = useMemo112(() => {
  ...
  return /* @__PURE__ */ jsxs108("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx212("div", {
        style: results,
        className: VERTICAL_SCROLLBAR_CLASSNAME,
        children: showKeyboardShortcuts ? /* @__PURE__ */ jsx212(KeyboardShortcutsExplainer, {}) : showSearchLoadingState ? null : resultsArray.length === 0 ? /* @__PURE__ */ jsx212(QuickSwitcherNoResults, {
          mode,
          query: actualQuery
        }) : resultsArray.map((result, i) => {
          return /* @__PURE__ */ jsx212(QuickSwitcherResult, {
...
var QuickSwitcher = ({ initialMode, invocationTimestamp, readOnlyStudio }) => {
  return /* @__PURE__ */ jsx213(DismissableModal, {
    children: /* @__PURE__ */ jsx213(QuickSwitcherContent, {
      readOnlyStudio,
      invocationTimestamp,
      initialMode
    })
...
import { useMemo as useMemo113, useState as useState67 } from "react";
var useRenderModalSections = (renderMode, codec) => {
  const [selectedTab, setTab] = useState67("general");
  const shownTabs = useMemo113(() => {
    if (renderMode === "audio") {
...
var AudioIcon = (props) => /* @__PURE__ */ jsx214("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
...
var PicIcon = (props) => /* @__PURE__ */ jsx216("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
...
var GearIcon = (props) => /* @__PURE__ */ jsx217("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
...
var GifIcon = (props) => /* @__PURE__ */ jsx218("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 576 512",
  ...props,
...
import { useCallback as useCallback103, useMemo as useMemo114, useState as useState68 } from "react";
...
var VerticalTab = ({ children, onClick, style: style11, selected }) => {
  ...
  const { tabIndex } = useZIndex();
  const onPointerEnter = useCallback103(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback103(() => {
    setHovered(false);
  }, []);
  const definiteStyle = useMemo114(() => {
    return {
      ...selectorButton2,
...
import { useCallback as useCallback104, useEffect as useEffect68, useMemo as useMemo115, useState as useState69 } from "react";
...
var CliCopyButton = ({
  ...
  const [copied, setCopied] = useState69(false);
  const [hovered, setHovered] = useState69(false);
  const fillColor = useMemo115(() => {
    return hovered ? "white" : LIGHT_TEXT;
  }, [hovered]);
  const clipboardIcon = /* @__PURE__ */ jsx220(ClipboardIcon, {
    color: fillColor,
    style: svgStyle3
  });
  const checkSvg = /* @__PURE__ */ jsx220("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 448 512",
    style: svgStyle3,
  ...
  const onPointerEnter = useCallback104(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback104(() => {
    setHovered(false);
  }, []);
  useEffect68(() => {
    if (!copied) {
  ...
  return copied ? /* @__PURE__ */ jsx220("span", {
    style: copiedStyle,
    children: checkSvg
  }) : /* @__PURE__ */ jsx220("button", {
    type: "button",
    onPointerEnter,
    onPointerLeave,
    style: buttonStyle6,
...
import { jsx as jsx221, jsxs as jsxs109 } from "react/jsx-runtime";
var container47 = {
  fontSize: 14,
  paddingTop: 10,
  paddingBottom: 10,
        ...
        children: [
          /* @__PURE__ */ jsxs109("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx221("div", {
                style: copyWrapper,
                children: /* @__PURE__ */ jsx221(CliCopyButton, {
...
var OptionExplainerBubble = ({ id }) => {
  ...
  return /* @__PURE__ */ jsx222(InfoBubble, {
    title: "Learn more about this option",
    children: /* @__PURE__ */ jsx222(OptionExplainer, {
      option
    })
  });
};
...
// src/components/RenderModal/NumberSetting.tsx
import { jsx as jsx223, jsxs as jsxs110, Fragment as Fragment34 } from "react/jsx-runtime";
var NumberSetting = ({ name, value, step, hint, onValueChanged, max, min, formatter }) => {
  const onTextChanged = useCallback105((e) => {
    onValueChanged((q) => {
  ...
  const onValueChange = useCallback105((newConcurrency) => {
  ...
  return /* @__PURE__ */ jsxs110("div", {
    ...
    children: [
        ...
        children: [
          ...
          hint ? /* @__PURE__ */ jsxs110(Fragment34, {
            children: [
              ...
              /* @__PURE__ */ jsx223(OptionExplainerBubble, {
                id: hint
              })
            ]
          }) : null
      ...
      /* @__PURE__ */ jsx223("div", {
        style: rightRow,
        children: /* @__PURE__ */ jsx223(RightAlignInput, {
          children: /* @__PURE__ */ jsx223(InputDragger, {
            value,
...
var useCrfState = (codec) => {
  const [state, setState] = useState70(() => getDefaultCrfState());
...
var CrfSetting = ({ crf, setCrf, min, max, option }) => {
  return /* @__PURE__ */ jsx224(NumberSetting, {
    min,
    max,
    name: "CRF",
...
import { useCallback as useCallback109, useMemo as useMemo116 } from "react";
...
import React149, { useCallback as useCallback107 } from "react";
...
var InlineEyeButton = ({ onClick, enabled }) => {
  const renderAction = useCallback106((color) => {
    return enabled ? /* @__PURE__ */ jsx225("svg", {
      style: clearIcon2,
      viewBox: "0 0 640 512",
  ...
  return /* @__PURE__ */ jsx225(InlineAction, {
    renderAction,
    onClick
  });
};
...
// src/components/RenderModal/EnvInput.tsx
import { jsx as jsx226, jsxs as jsxs111, Fragment as Fragment35 } from "react/jsx-runtime";
var input3 = {
  flex: 1,
  width: "100%"
};
...
var EnvInput = ({
  ...
  const [showInPlainText, setShowInPlainText] = React149.useState(false);
  const [initialWarningKeyMissing, setKeyWarningEligible] = React149.useState(() => {
    return envKey.trim() === "" && envVal.trim() !== "";
  });
  const [initialWarningValMissing, setValueWarningEligible] = React149.useState(() => {
    return envKey.trim() !== "" && envVal.trim() === "";
  });
  ...
  const togglePlainText = useCallback107(() => {
    setShowInPlainText((prev) => !prev);
  }, []);
  const handleKeyChange = useCallback107((e) => {
    onEnvKeyChange(index, e.target.value);
  }, [index, onEnvKeyChange]);
  const handleValueChange = useCallback107((e) => {
    onEnvValChange(index, e.target.value);
  }, [index, onEnvValChange]);
  const makeKeyWarningEligible = useCallback107(() => {
    setKeyWarningEligible(true);
  }, []);
  const makeValueWarningEligible = useCallback107(() => {
    ...
    children: [
      /* @__PURE__ */ jsxs111(Row, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx226(InlineEyeButton, {
            enabled: !showInPlainText,
            onClick: togglePlainText
          }),
          /* @__PURE__ */ jsx226(InlineRemoveButton, {
            onClick: handleDelete
          })
        ]
      }),
      isNodeEnvKey ? /* @__PURE__ */ jsx226("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx226(ValidationMessage, {
          align: "flex-start",
          type: "warning",
          message: "NODE_ENV will be overwritten by Remotion during the render process."
        })
      }) : null,
      isDuplicate ? /* @__PURE__ */ jsx226("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx226(ValidationMessage, {
          align: "flex-start",
          type: "warning",
      ...
      isKeyMissing ? /* @__PURE__ */ jsx226("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx226(ValidationMessage, {
          align: "flex-start",
          type: "warning",
      ...
      isValMissing ? /* @__PURE__ */ jsx226("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx226(ValidationMessage, {
          align: "flex-start",
          type: "warning",
...
// src/components/RenderModal/RenderModalEnvironmentVariables.tsx
import { jsx as jsx227, jsxs as jsxs112 } from "react/jsx-runtime";
var title6 = {
  fontSize: 14,
  fontWeight: "bold",
  color: LIGHT_TEXT,
...
var RenderModalEnvironmentVariables = ({ envVariables, setEnvVariables }) => {
  const onEnvValChange = useCallback108((index, value) => {
  ...
  const onEnvKeyChange = useCallback108((index, value) => {
    setEnvVariables((oldEnv) => {
      const newEnv = [...oldEnv];
  ...
  const onDelete = useCallback108((index) => {
    setEnvVariables((oldEnv) => oldEnv.filter((_, idx) => idx !== index));
  }, [setEnvVariables]);
  const addField = useCallback108(() => {
  ...
  return /* @__PURE__ */ jsxs112("div", {
    ...
    children: [
      ...
      envVariables.map((env, i) => {
        ...
        return /* @__PURE__ */ jsx227(EnvInput, {
          onEnvKeyChange,
          onEnvValChange,
          envKey: env[0],
          envVal: env[1],
...
var RenderModalAdvanced = ({
  ...
  const extendedOpenGlOptions = useMemo116(() => {
    return [
      "angle",
      "egl",
      "swangle",
  ...
  const toggleCustomOffthreadVideoCacheSizeInBytes = useCallback109(() => {
  ...
  const toggleCustomOffthreadVideoThreads = useCallback109(() => {
  ...
  const toggleCustomUserAgent = useCallback109(() => {
  ...
  const onDisallowParallelEncodingChanged = useCallback109((e) => {
    setDisallowParallelEncoding(e.target.checked);
  }, [setDisallowParallelEncoding]);
  const onDisableWebSecurityChanged = useCallback109((e) => {
    setDisableWebSecurity(e.target.checked);
  }, [setDisableWebSecurity]);
  const onEnableMultiProcessOnLinux = useCallback109((e) => {
    setChromiumMultiProcessOnLinux(e.target.checked);
  }, [setChromiumMultiProcessOnLinux]);
  const onIgnoreCertificatErrors = useCallback109((e) => {
    setIgnoreCertificateErrors(e.target.checked);
  }, [setIgnoreCertificateErrors]);
  const onHeadless = useCallback109((e) => {
    setHeadless(e.target.checked);
  }, [setHeadless]);
  const onUserAgentChanged = useCallback109((e) => {
    setUserAgent(e.target.value);
  }, [setUserAgent]);
  const onPlayBeepSound = useCallback109((e) => {
    setBeep(e.target.checked);
  }, [setBeep]);
  const onReproToggle = useCallback109((e) => {
    setRepro(e.target.checked);
  }, [setRepro]);
  const openGlOptions = useMemo116(() => {
    return extendedOpenGlOptions.map((option) => {
      return {
        label: option === "default" ? "Default" : option,
        onClick: () => setOpenGlOption(option),
        key: option,
        leftItem: openGlOption === option ? /* @__PURE__ */ jsx229(Checkmark, {}) : null,
        id: option,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const chromeModeOptions = useMemo116(() => {
    return BrowserSafeApis3.validChromeModeOptions.map((option) => {
      return {
        label: option,
        onClick: () => setChromeModeOption(option),
        key: option,
        leftItem: chromeModeOption === option ? /* @__PURE__ */ jsx229(Checkmark, {}) : null,
        id: option,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const x264PresetOptions = useMemo116(() => {
    return BrowserSafeApis3.x264PresetOptions.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: x264Preset === option ? /* @__PURE__ */ jsx229(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        value: option
      };
  ...
  const hardwareAccelerationValues = useMemo116(() => {
    return BrowserSafeApis3.hardwareAccelerationOptions.map((option) => {
      return {
        label: option,
        onClick: () => setHardwareAcceleration(option),
        leftItem: hardwareAcceleration === option ? /* @__PURE__ */ jsx229(Checkmark, {}) : null,
        subMenu: null,
        quickSwitcherLabel: null,
        type: "item",
        id: option,
  ...
  const changeOffthreadVideoCacheSizeInBytes = useCallback109((cb) => {
  ...
  const changeOffthreadVideoThreads = useCallback109((cb) => {
  ...
  return /* @__PURE__ */ jsxs113("div", {
    ...
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: [
      renderMode === "still" ? null : /* @__PURE__ */ jsx229(NumberSetting, {
        min: minConcurrency,
        max: maxConcurrency,
        step: 1,
        name: "Concurrency",
      ...
      renderMode === "audio" || offthreadVideoCacheSizeInBytes === null ? null : /* @__PURE__ */ jsx229(NumberSetting, {
        min: 0,
        max: 2000 * 1024 * 1024,
        step: 1024,
      ...
      renderMode === "audio" || offthreadVideoThreads === null ? null : /* @__PURE__ */ jsx229(NumberSetting, {
        min: 0,
        max: 16,
        step: 1,
      ...
      /* @__PURE__ */ jsx229(RenderModalHr, {}),
      /* @__PURE__ */ jsx229(RenderModalEnvironmentVariables, {
        envVariables,
        setEnvVariables
      })
    ]
...
import { jsx as jsx230, jsxs as jsxs114 } from "react/jsx-runtime";
var EnforceAudioTrackSetting = ({ enforceAudioTrack, muted, setEnforceAudioTrack }) => {
  const onEnforceAudioTrackChanged = useCallback110((e) => {
...
import { jsx as jsx231, jsxs as jsxs115 } from "react/jsx-runtime";
var MutedSetting = ({ muted, setMuted, enforceAudioTrack }) => {
  const onMutedChanged = useCallback111((e) => {
...
import { useContext as useContext76, useEffect as useEffect69, useRef as useRef37, useState as useState71 } from "react";
var useFileExistence = (outName) => {
  const [exists, setExists] = useState71(false);
  const { previewServerState: state, subscribeToEvent } = useContext76(StudioServerConnectionCtx);
...
import { jsx as jsx232, jsxs as jsxs116, Fragment as Fragment36 } from "react/jsx-runtime";
          ...
          children: [
            ...
            validationMessage ? /* @__PURE__ */ jsxs116(Fragment36, {
              children: [
                ...
                /* @__PURE__ */ jsx232(ValidationMessage, {
                  align: "flex-end",
...
// src/components/RenderModal/SeparateAudioOption.tsx
import { jsx as jsx233, jsxs as jsxs117, Fragment as Fragment37 } from "react/jsx-runtime";
var SeparateAudioOptionInput = ({ separateAudioTo, setSeparateAudioTo, audioCodec }) => {
  ...
  const validationMessage = useMemo117(() => {
  ...
  return /* @__PURE__ */ jsx233(RenderModalOutputName, {
    existence,
    inputStyle: input,
    onValueChange,
...
var SeparateAudioOption = ({ separateAudioTo, setSeparateAudioTo, audioCodec, outName }) => {
  const onSeparateAudioChange = useCallback112((e) => {
    if (e.target.checked) {
  ...
  return /* @__PURE__ */ jsxs117(Fragment37, {
    children: [
      ...
      separateAudioTo === null ? null : /* @__PURE__ */ jsx233(SeparateAudioOptionInput, {
        separateAudioTo,
        setSeparateAudioTo,
        audioCodec
      })
...
// src/components/RenderModal/RenderModalAudio.tsx
import { jsx as jsx234, jsxs as jsxs118, Fragment as Fragment38 } from "react/jsx-runtime";
var container50 = {
  flex: 1,
  overflowY: "auto"
};
var RenderModalAudio = ({
  ...
  const onShouldHaveTargetAudioBitrateChanged = useCallback113((e) => {
    setShouldHaveCustomTargetAudioBitrate(e.target.checked);
  }, [setShouldHaveCustomTargetAudioBitrate]);
  const onTargetAudioBitrateChanged = useCallback113((e) => {
    setCustomTargetAudioBitrateValue(e.target.value);
  }, [setCustomTargetAudioBitrateValue]);
  const onSeamlessAacConcatenationChanges = useCallback113((e) => {
    setForSeamlessAacConcatenation(e.target.checked);
  }, [setForSeamlessAacConcatenation]);
  const audioCodecOptions = useCallback113((currentCodec) => {
    return BrowserSafeApis5.supportedAudioCodecs[currentCodec].map((audioCodecOption) => {
      return {
        ...
        leftItem: codec === audioCodecOption ? /* @__PURE__ */ jsx234(Checkmark, {}) : null,
        id: audioCodecOption,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  return /* @__PURE__ */ jsxs118("div", {
    ...
    children: [
      renderMode === "video" ? /* @__PURE__ */ jsxs118(Fragment38, {
        children: [
          /* @__PURE__ */ jsx234(MutedSetting, {
            enforceAudioTrack,
            muted,
            setMuted
          }),
          /* @__PURE__ */ jsx234(RenderModalHr, {})
        ]
      }) : null,
      renderMode === "video" && audioCodecOptions(codec).length >= 2 && !muted ? /* @__PURE__ */ jsxs118("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx234("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx234(Combobox, {
      ...
      (renderMode === "video" || renderMode === "audio") && !muted && /* @__PURE__ */ jsxs118(Fragment38, {
        children: [
          /* @__PURE__ */ jsx234(EnforceAudioTrackSetting, {
            muted,
            enforceAudioTrack,
      ...
      renderMode === "video" && !muted ? /* @__PURE__ */ jsx234(SeparateAudioOption, {
        separateAudioTo,
        setSeparateAudioTo,
        audioCodec,
        outName
        ...
        children: [
          ...
          /* @__PURE__ */ jsx234("div", {
            ...
            children: /* @__PURE__ */ jsx234("div", {
              children: /* @__PURE__ */ jsx234(RemotionInput, {
                style: input,
...
import { useCallback as useCallback116, useMemo as useMemo119 } from "react";
...
var MultiRangeSlider = ({
  ...
  const getPercent = useCallback114((value) => Math.round((value - min) / (max - min) * 100), [min, max]);
  const rangeStyle = useMemo118(() => {
  ...
  const onChangeLeft = useCallback114((event) => {
    const value = Math.min(Number(event.target.value), end - 1);
    onLeftThumbDrag(value);
  }, [end, onLeftThumbDrag]);
  const onChangeRight = useCallback114((event) => {
...
// src/components/RenderModal/FrameRangeSetting.tsx
import { jsx as jsx236, jsxs as jsxs120 } from "react/jsx-runtime";
var INPUT_WIDTH = 40;
var FrameRangeSetting = ({ startFrame, endFrame, setEndFrame, durationInFrames, setStartFrame }) => {
  ...
  const onStartFrameChangedDirectly = useCallback115((newStartFrame) => {
    setStartFrame(newStartFrame);
  }, [setStartFrame]);
  const onEndFrameChangedDirectly = useCallback115((newEndFrame) => {
    setEndFrame(newEndFrame);
  }, [setEndFrame]);
  const onStartFrameChanged = useCallback115((newVal) => {
    onStartFrameChangedDirectly(parseInt(newVal, 10));
  }, [onStartFrameChangedDirectly]);
  const onEndFrameChanged = useCallback115((newVal) => {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs120("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx236(MultiRangeSlider, {
            min: minStartFrame,
            max: maxEndFrame,
            start: startFrame,
            end: endFrame,
...
// src/components/RenderModal/RenderModalBasic.tsx
import { jsx as jsx237, jsxs as jsxs121 } from "react/jsx-runtime";
var container52 = {
  flex: 1
};
var RenderModalBasic = ({
  ...
  const videoCodecOptions = useMemo119(() => {
    return BrowserSafeApis6.validCodecs.filter((c) => {
      ...
      return {
        ...
        key: codecOption,
        leftItem: codec === codecOption ? /* @__PURE__ */ jsx237(Checkmark, {}) : null,
        id: codecOption,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const proResProfileOptions = useMemo119(() => {
  ...
  const onFrameSetDirectly = useCallback116((newFrame) => {
    setFrame(newFrame);
  }, [setFrame]);
  const onFrameChanged = useCallback116((e) => {
    setFrame((q) => {
  ...
  const onVerboseLoggingChanged = useCallback116((e) => {
  ...
  return /* @__PURE__ */ jsxs121("div", {
    ...
    children: [
      ...
      renderMode === "still" ? null : /* @__PURE__ */ jsx237(FrameRangeSetting, {
      ...
      /* @__PURE__ */ jsx237(RenderModalOutputName, {
        existence,
        inputStyle: input,
        outName,
        onValueChange,
...
import { jsx as jsx238, jsxs as jsxs122 } from "react/jsx-runtime";
var min = 0;
var NumberOfLoopsSetting = ({ numberOfGifLoops, setNumberOfGifLoops }) => {
  const onNumberOfGifLoopsChangedDirectly = useCallback117((newConcurrency) => {
    setNumberOfGifLoops(newConcurrency);
  }, [setNumberOfGifLoops]);
  const onNumberOfGifLoopsChanged = useCallback117((e) => {
  ...
  return /* @__PURE__ */ jsxs122("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx238("div", {
        style: rightRow,
        children: /* @__PURE__ */ jsx238(RightAlignInput, {
          children: /* @__PURE__ */ jsx238(InputDragger, {
...
// src/components/RenderModal/RenderModalGif.tsx
import { jsx as jsx239, jsxs as jsxs123 } from "react/jsx-runtime";
var container53 = {
  flex: 1
};
var RenderModalGif = ({
  ...
  const onShouldLimitNumberOfGifLoops = useCallback118((e) => {
    setLimitNumberOfGifLoops(e.target.checked);
  }, [setLimitNumberOfGifLoops]);
  return /* @__PURE__ */ jsxs123("div", {
    style: container53,
    children: [
      /* @__PURE__ */ jsx239(NumberSetting, {
      ...
      limitNumberOfGifLoops ? /* @__PURE__ */ jsx239(NumberOfLoopsSetting, {
...
import { useCallback as useCallback119, useMemo as useMemo120 } from "react";
...
var JpegQualitySetting = ({ jpegQuality, setJpegQuality }) => {
  return /* @__PURE__ */ jsx240(NumberSetting, {
...
var ScaleSetting = ({ scale, setScale }) => {
  return /* @__PURE__ */ jsx241(NumberSetting, {
    min: MIN_SCALE,
    max: MAX_SCALE,
    step: 0.1,
    name: "Scale",
...
// src/components/RenderModal/RenderModalPicture.tsx
import { jsx as jsx242, jsxs as jsxs124, Fragment as Fragment39 } from "react/jsx-runtime";
...
var RenderModalPicture = ({
  ...
  const colorSpaceOptions = useMemo120(() => {
    return BrowserSafeApis7.validColorSpaces.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: colorSpace === option ? /* @__PURE__ */ jsx242(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        type: "item",
        value: option
  ...
  const qualityControlOptions = useMemo120(() => {
  ...
  const onTargetVideoBitrateChanged = useCallback119((e) => {
    setCustomTargetVideoBitrateValue(e.target.value);
  }, [setCustomTargetVideoBitrateValue]);
  const onEncodingBufferSizeToggled = useCallback119((e) => {
    setEncodingBufferSize(e.target.checked ? "10000k" : null);
  }, [setEncodingBufferSize]);
  const onEncodingMaxRateToggled = useCallback119((e) => {
    setEncodingMaxRate(e.target.checked ? "5000k" : null);
  }, [setEncodingMaxRate]);
  const onEncodingBufferSizeChanged = useCallback119((e) => {
    setEncodingBufferSize(e.target.value);
  }, [setEncodingBufferSize]);
  const onEncodingMaxRateChanged = useCallback119((e) => {
    ...
    children: [
      renderMode === "video" ? /* @__PURE__ */ jsxs124("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx242("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx242(SegmentedControl, {
              items: imageFormatOptions,
              needsWrapping: false
            })
          })
      ...
      renderMode === "video" && videoImageFormat === "jpeg" && /* @__PURE__ */ jsx242(JpegQualitySetting, {
        jpegQuality,
        setJpegQuality
      }),
      renderMode === "still" && stillImageFormat === "jpeg" && /* @__PURE__ */ jsx242(JpegQualitySetting, {
        jpegQuality,
        setJpegQuality
      }),
      renderMode === "video" && qualityControlType !== null ? /* @__PURE__ */ jsx242(RenderModalHr, {}) : null,
      ...
      qualityControlType === "crf" && renderMode !== "still" && renderMode !== "sequence" && crf !== null ? /* @__PURE__ */ jsx242(CrfSetting, {
        crf,
        min: minCrf,
        max: maxCrf,
        setCrf,
      ...
      qualityControlType === "bitrate" && renderMode === "video" ? /* @__PURE__ */ jsxs124("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx242("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx242("div", {
              children: /* @__PURE__ */ jsx242(RemotionInput, {
                style: input,
      ...
      renderMode === "video" ? /* @__PURE__ */ jsx242(RenderModalHr, {}) : null,
      /* @__PURE__ */ jsx242(ScaleSetting, {
        scale,
        setScale
      }),
      renderMode === "video" ? /* @__PURE__ */ jsx242(RenderModalHr, {}) : null,
      renderMode === "video" ? /* @__PURE__ */ jsxs124("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx242("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx242(Combobox, {
...
var RenderModal = ({
  ...
  const [unclampedFrame, setFrame] = useState72(() => initialFrame);
  const [saving, setSaving] = useState72(false);
  const [stillImageFormat, setStillImageFormat] = useState72(() => initialStillImageFormat);
  const [videoImageFormat, setVideoImageFormat] = useState72(() => initialVideoImageFormat);
  const [sequenceImageFormat, setSequenceImageFormat] = useState72(() => initialStillImageFormat === "jpeg" ? "jpeg" : "png");
  const [concurrency, setConcurrency] = useState72(() => initialConcurrency);
  const [videoCodecForVideoTab, setVideoCodecForVideoTab] = useState72(() => initialVideoCodecForVideoTab);
  const [userSelectedAudioCodec, setUserSelectedAudioCodec] = useState72(() => initialAudioCodec);
  const [separateAudioTo, setSeparateAudioTo] = useState72(null);
  const [envVariables, setEnvVariables] = useState72(() => envVariablesObjectToArray(initialEnvVariables).filter(([key5]) => key5 !== "NODE_ENV"));
  const [initialOutName] = useState72(() => {
  ...
  const [videoCodecForAudioTab, setVideoCodecForAudioTab] = useState72(() => initialVideoCodecForAudioTab);
  const [mutedState, setMuted] = useState72(() => initialMuted);
  const [repro, setRepro] = useState72(() => initialRepro);
  const [enforceAudioTrackState, setEnforceAudioTrackState] = useState72(() => initialEnforceAudioTrack);
  const [forSeamlessAacConcatenation, setForSeamlessAacConcatenation] = useState72(() => initialForSeamlessAacConcatenation);
  const [renderMode, setRenderModeState] = useState72(initialRenderType);
  const [jpegQuality, setJpegQuality] = useState72(() => initialJpegQuality);
  const [scale, setScale] = useState72(() => initialScale);
  const [logLevel, setLogLevel] = useState72(() => initialLogLevel);
  const [disallowParallelEncoding, setDisallowParallelEncoding] = useState72(false);
  const [disableWebSecurity, setDisableWebSecurity] = useState72(() => initialDisableWebSecurity);
  const [headless, setHeadless] = useState72(() => initialHeadless);
  const [beepOnFinish, setBeepOnFinish] = useState72(() => initialBeep);
  const [ignoreCertificateErrors, setIgnoreCertificateErrors] = useState72(() => initialIgnoreCertificateErrors);
  const [multiProcessOnLinux, setChromiumMultiProcessOnLinux] = useState72(() => initialMultiProcessOnLinux);
  const [openGlOption, setOpenGlOption] = useState72(() => initialGl ?? "default");
  const [colorSpace, setColorSpace] = useState72(() => initialColorSpace);
  const [userAgent, setUserAgent] = useState72(() => initialUserAgent === null ? null : initialUserAgent.trim() === "" ? null : initialUserAgent);
  const chromiumOptions = useMemo121(() => {
    return {
      headless,
      disableWebSecurity,
      ignoreCertificateErrors,
  ...
  const [outName, setOutName] = useState72(() => initialOutName);
  const [endFrameOrNull, setEndFrame] = useState72(() => outFrameMark ?? null);
  const [startFrameOrNull, setStartFrame] = useState72(() => inFrameMark ?? null);
  const [proResProfileSetting, setProResProfile] = useState72(() => initialProResProfile);
  const [x264PresetSetting, setx264Preset] = useState72(() => initialx264Preset);
  const [hardwareAcceleration, setHardwareAcceleration] = useState72(() => initialHardwareAcceleration);
  const [userPreferredPixelFormat, setPixelFormat] = useState72(() => initialPixelFormat);
  const [preferredQualityControlType, setQualityControl] = useState72(() => initialVideoBitrate === null ? "crf" : "bitrate");
  const [
    shouldHaveCustomTargetAudioBitrate,
    setShouldHaveCustomTargetAudioBitrate
  ] = useState72(() => initialAudioBitrate !== null);
  const [customTargetAudioBitrate, setCustomTargetAudioBitrateValue] = useState72(() => initialAudioBitrate ?? "320K");
  const [customTargetVideoBitrate, setCustomTargetVideoBitrateValue] = useState72(() => initialVideoBitrate ?? "1M");
  const [encodingMaxRate, setEncodingMaxRate] = useState72(() => initialEncodingMaxRate ?? null);
  const [encodingBufferSize, setEncodingBufferSize] = useState72(() => initialEncodingBufferSize ?? null);
  const [limitNumberOfGifLoops, setLimitNumberOfGifLoops] = useState72(() => initialNumberOfGifLoops !== null);
  const [numberOfGifLoopsSetting, setNumberOfGifLoopsSetting] = useState72(() => initialNumberOfGifLoops ?? 0);
  const [delayRenderTimeout, setDelayRenderTimeout] = useState72(() => initialDelayRenderTimeout);
  const [chromeMode, setChromeMode] = useState72(() => initialChromeMode);
  const [offthreadVideoCacheSizeInBytes, setOffthreadVideoCacheSizeInBytes] = useState72(initialOffthreadVideoCacheSizeInBytes);
  const [offthreadVideoThreads, setOffthreadVideoThreads] = useState72(() => initialOffthreadVideoThreads);
  const codec = useMemo121(() => {
    if (renderMode === "audio") {
      return videoCodecForAudioTab;
    }
    return videoCodecForVideoTab;
  }, [videoCodecForAudioTab, renderMode, videoCodecForVideoTab]);
  const numberOfGifLoops = useMemo121(() => {
    if (codec === "gif" && limitNumberOfGifLoops) {
      return numberOfGifLoopsSetting;
    }
    return null;
  }, [codec, limitNumberOfGifLoops, numberOfGifLoopsSetting]);
  const audioBitrate = useMemo121(() => {
  ...
  const supportsBothQualityControls = useMemo121(() => {
    return supportsCrf && supportsVideoBitrate;
  }, [supportsCrf, supportsVideoBitrate]);
  const qualityControlType = useMemo121(() => {
  ...
  const dispatchIfMounted = useCallback120((payload) => {
    if (isMounted.current === false)
      return;
    dispatch(payload);
  }, []);
  const muted = useMemo121(() => {
    if (renderMode === "video") {
      return mutedState;
    }
    return false;
  }, [mutedState, renderMode]);
  const enforceAudioTrack = useMemo121(() => {
    if (renderMode === "video") {
  ...
  const deriveFinalAudioCodec = useCallback120((passedVideoCodec, passedAudioCodec) => {
  ...
  const setDefaultOutName = useCallback120((options) => {
  ...
  const setAudioCodec = useCallback120((newAudioCodec) => {
  ...
  const setCodec = useCallback120((newCodec) => {
    if (renderMode === "audio") {
  ...
  const setStillFormat = useCallback120((format) => {
    setStillImageFormat(format);
    setDefaultOutName({ type: "still", imageFormat: format });
  }, [setDefaultOutName]);
  const { setSidebarCollapsedState } = useContext77(SidebarContext);
  const onClickStill = useCallback120(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
  ...
  const [everyNthFrameSetting, setEveryNthFrameSetting] = useState72(() => initialEveryNthFrame);
  const everyNthFrame = useMemo121(() => {
    if (codec === "gif") {
  ...
  const availablePixelFormats = useMemo121(() => {
    return BrowserSafeApis10.validPixelFormatsForCodec(codec);
  }, [codec]);
  const pixelFormat = useMemo121(() => {
  ...
  const onClickVideo = useCallback120(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
    optionsSidebarTabs.current?.selectRendersPanel();
    dispatchIfMounted({ type: "start" });
  ...
  const onClickSequence = useCallback120(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
    optionsSidebarTabs.current?.selectRendersPanel();
    dispatchIfMounted({ type: "start" });
  ...
  const imageFormatOptions = useMemo121(() => {
    if (renderMode === "still") {
      return [
        {
          label: "PNG",
  ...
  const setRenderMode = useCallback120((newRenderMode) => {
  ...
  const renderTabOptions = useMemo121(() => {
  ...
  const pixelFormatOptions = useMemo121(() => {
    return availablePixelFormats.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: pixelFormat === option ? /* @__PURE__ */ jsx243(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        type: "item",
        value: option
  ...
  return /* @__PURE__ */ jsxs125("div", {
    style: outer4,
    children: [
      /* @__PURE__ */ jsx243(ModalHeader, {
        title: `Render ${resolvedComposition.id}`
      }),
      /* @__PURE__ */ jsxs125("div", {
        style: container55,
        children: [
          /* @__PURE__ */ jsx243(SegmentedControl, {
      ...
      /* @__PURE__ */ jsxs125("div", {
        ...
        children: [
            ...
            children: [
              shownTabs.includes("general") ? /* @__PURE__ */ jsxs125(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx243("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx243(FileIcon, {
                      style: icon6
                    })
                  }),
                  "General"
              ...
              shownTabs.includes("data") ? /* @__PURE__ */ jsxs125(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx243("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx243(DataIcon, {
                      style: icon6
                    })
                  }),
                  "Input Props"
              ...
              shownTabs.includes("picture") ? /* @__PURE__ */ jsxs125(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx243("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx243(PicIcon, {
                      style: icon6
                    })
                  }),
                  "Picture"
              ...
              shownTabs.includes("audio") ? /* @__PURE__ */ jsxs125(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx243("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx243(AudioIcon, {
                      style: icon6
                    })
                  }),
                  "Audio"
              ...
              shownTabs.includes("gif") ? /* @__PURE__ */ jsxs125(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx243("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx243(GifIcon, {
                      style: icon6
                    })
                  }),
                  "GIF"
              ...
              shownTabs.includes("advanced") ? /* @__PURE__ */ jsxs125(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx243("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx243(GearIcon, {
                      style: icon6
                    })
                  }),
                  "Other"
          ...
          /* @__PURE__ */ jsx243("div", {
            style: optionsPanel,
            className: VERTICAL_SCROLLBAR_CLASSNAME,
            children: tab === "general" ? /* @__PURE__ */ jsx243(RenderModalBasic, {
              codec,
              resolvedComposition,
              frame: frame2,
              imageFormatOptions,
            ...
            }) : tab === "picture" ? /* @__PURE__ */ jsx243(RenderModalPicture, {
              renderMode,
              scale,
              setScale,
              pixelFormat,
              ...
              encodingMaxRate,
              setEncodingMaxRate
            }) : tab === "audio" ? /* @__PURE__ */ jsx243(RenderModalAudio, {
              muted,
              renderMode,
              setMuted,
              codec,
              ...
              setSeparateAudioTo,
              outName
            }) : tab === "gif" ? /* @__PURE__ */ jsx243(RenderModalGif, {
              everyNthFrame,
              limitNumberOfGifLoops,
              numberOfGifLoopsSetting,
              setEveryNthFrameSetting,
              setLimitNumberOfGifLoops,
              setNumberOfGifLoopsSetting
            }) : tab === "data" ? /* @__PURE__ */ jsx243(DataEditor, {
            ...
            }) : /* @__PURE__ */ jsx243(RenderModalAdvanced, {
              x264Preset,
              setx264Preset,
              concurrency,
              maxConcurrency,
...
var RenderModalWithLoader = (props) => {
  return /* @__PURE__ */ jsx243(DismissableModal, {
    children: /* @__PURE__ */ jsx243(ResolveCompositionBeforeModal, {
      compositionId: props.compositionId,
      children: /* @__PURE__ */ jsx243(RenderModal, {
        ...props
      })
    })
  });
...
import { useCallback as useCallback122, useContext as useContext78 } from "react";

// src/components/RenderModal/GuiRenderStatus.tsx
import { useCallback as useCallback121, useMemo as useMemo122 } from "react";
...
var BundlingProgress = ({ progress, doneIn }) => {
  return /* @__PURE__ */ jsxs126("div", {
    style: progressItem,
    children: [
      progress === 1 ? /* @__PURE__ */ jsx245(SuccessIcon, {}) : /* @__PURE__ */ jsx245(CircularProgress, {
        progress
      }),
...
var RenderingProgress = ({ progress }) => {
  return /* @__PURE__ */ jsxs126("div", {
    style: progressItem,
    children: [
      progress.frames === progress.totalFrames ? /* @__PURE__ */ jsx245(SuccessIcon, {}) : /* @__PURE__ */ jsx245(CircularProgress, {
...
var OpenFile = ({ job }) => {
  ...
  return /* @__PURE__ */ jsxs126("div", {
    style: progressItem,
    children: [
      /* @__PURE__ */ jsx245(SuccessIcon, {}),
      /* @__PURE__ */ jsx245(Spacing, {
        x: 1
      }),
      /* @__PURE__ */ jsx245("button", {
        style: labelStyle5,
        type: "button",
        onClick,
        children: job.outName
      ...
      /* @__PURE__ */ jsx245("div", {
        style: right3,
        children: /* @__PURE__ */ jsx245(RenderQueueOpenInFinderItem, {
          job
        })
      })
    ]
...
var GuiRenderStatus = ({ job }) => {
  ...
  return /* @__PURE__ */ jsxs126("div", {
    children: [
      ...
      /* @__PURE__ */ jsx245(BundlingProgress, {
        progress: job.progress.bundling.progress,
        doneIn: job.progress.bundling.doneIn
      }),
      job.progress.rendering ? /* @__PURE__ */ jsx245(RenderingProgress, {
        progress: job.progress.rendering
      }) : null,
      job.progress.stitching ? /* @__PURE__ */ jsx245(StitchingProgress, {
        progress: job.progress.stitching
      }) : null,
      job.progress.downloads.length > 0 ? /* @__PURE__ */ jsx245(DownloadsProgress, {
        downloads: job.progress.downloads
      }) : null,
      job.status === "done" ? /* @__PURE__ */ jsx245(OpenFile, {
        job
      }) : null,
      /* @__PURE__ */ jsx245(Spacing, {
        y: 1
...
// src/components/RenderModal/RenderStatusModal.tsx
import { jsx as jsx246, jsxs as jsxs127, Fragment as Fragment40 } from "react/jsx-runtime";
var container56 = {
  padding: 20,
  maxWidth: 900,
  paddingTop: 0
...
var RenderStatusModal = ({
  ...
  const { jobs } = useContext78(RenderQueueContext);
  const job = jobs.find((j) => j.id === jobId);
  if (!job) {
    throw new Error("job not found");
  }
  const onQuit = useCallback122(() => {
    setSelectedModal(null);
  }, [setSelectedModal]);
  const onRetry = useCallback122(() => {
    const retryPayload = makeRetryPayload(job);
    setSelectedModal(retryPayload);
  }, [job, setSelectedModal]);
  const onClickOnRemove = useCallback122(() => {
    setSelectedModal(null);
    removeRenderJob(job).catch((err) => {
      showNotification(`Could not remove job: ${err.message}`, 2000);
    });
  }, [job, setSelectedModal]);
  const onClickOnCancel = useCallback122(() => {
    cancelRenderJob(job).catch((err) => {
      showNotification(`Could not cancel job: ${err.message}`, 2000);
    });
  }, [job]);
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs127("div", {
        ...
        children: [
          ...
          job.status === "done" || job.status === "running" ? /* @__PURE__ */ jsx246(GuiRenderStatus, {
            job
          }) : null,
          /* @__PURE__ */ jsx246("div", {
            style: spacer3
...
import { useCallback as useCallback125, useMemo as useMemo124 } from "react";

// src/components/CopyButton.tsx
import { useCallback as useCallback123, useEffect as useEffect71, useState as useState73 } from "react";
import { jsx as jsx247, jsxs as jsxs128 } from "react/jsx-runtime";
var iconStyle8 = {
  width: 16,
  height: 16,
  color: "white"
...
var copyIcon = /* @__PURE__ */ jsx247("svg", {
  "aria-hidden": "true",
  focusable: "false",
  "data-prefix": "far",
  "data-icon": "clipboard",
...
import { useCallback as useCallback124, useMemo as useMemo123, useState as useState74 } from "react";
...
var OpenIssueButton = ({ link: link3 }) => {
  ...
  const handleClick = useCallback124(() => {
    window.open(link3, "_blank");
  }, [link3]);
  const svgFillColor = useMemo123(() => {
    return hovered ? "white" : LIGHT_TEXT;
  }, [hovered]);
  const openInEditorSvg = /* @__PURE__ */ jsx248("svg", {
    viewBox: "0 0 512 512",
    style: svgStyle4,
    children: /* @__PURE__ */ jsx248("path", {
      fill: svgFillColor,
      d: "M320 0c-17.7 0-32 14.3-32 32s14.3 32 32 32h82.7L201.4 265.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L448 109.3V192c0 17.7 14.3 32 32 32s32-14.3 32-32V32c0-17.7-14.3-32-32-32H320zM80 32C35.8 32 0 67.8 0 112V432c0 44.2 35.8 80 80 80H400c44.2 0 80-35.8 80-80V320c0-17.7-14.3-32-32-32s-32 14.3-32 32V432c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16V112c0-8.8 7.2-16 16-16H192c17.7 0 32-14.3 32-32s-14.3-32-32-32H80z"
    })
  });
  ...
  const onPointerLeave = useCallback124(() => {
    setHovered(false);
  }, []);
  return /* @__PURE__ */ jsx248("button", {
    title: buttonTooltip,
    type: "button",
    onPointerEnter,
    onPointerLeave,
  ...
  const bugElements = bugs.map((bug) => {
    return /* @__PURE__ */ jsxs129("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx249(OpenIssueButton, {
          link: bug.link
        })
      ]
    }, bug.description + bug.link);
  });
  return /* @__PURE__ */ jsx249("div", {
    children: bugElements
  });
};

// src/components/UpdateModal/UpdateModal.tsx
import { jsx as jsx250, jsxs as jsxs130, Fragment as Fragment41 } from "react/jsx-runtime";
var container58 = {
  padding: 20,
  paddingTop: 0
};
      ...
      /* @__PURE__ */ jsxs130("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs130(Row, {
            align: "center",
            children: [
              /* @__PURE__ */ jsx250(Flex, {
                children: /* @__PURE__ */ jsx250("pre", {
                  onClick,
                  style: code,
                  children: command
                })
...
// src/components/Modals.tsx
import { jsx as jsx251, jsxs as jsxs131, Fragment as Fragment42 } from "react/jsx-runtime";
var Modals = ({ readOnlyStudio }) => {
  const { selectedModal: modalContextType } = useContext79(ModalsContext);
  const canRender = useContext79(StudioServerConnectionCtx).previewServerState.type === "connected";
  return /* @__PURE__ */ jsxs131(Fragment42, {
    children: [
      modalContextType && modalContextType.type === "duplicate-comp" && /* @__PURE__ */ jsx251(DuplicateComposition, {
        compositionType: modalContextType.compositionType,
        compositionId: modalContextType.compositionId
      }),
      modalContextType && modalContextType.type === "delete-comp" && /* @__PURE__ */ jsx251(DeleteComposition, {
        compositionId: modalContextType.compositionId
      }),
      modalContextType && modalContextType.type === "rename-comp" && /* @__PURE__ */ jsx251(RenameComposition, {
        compositionId: modalContextType.compositionId
      }),
      modalContextType && canRender && modalContextType.type === "render" && /* @__PURE__ */ jsx251(RenderModalWithLoader, {
      ...
      modalContextType && canRender && modalContextType.type === "render-progress" && /* @__PURE__ */ jsx251(RenderStatusModal, {
        jobId: modalContextType.jobId
      }),
      modalContextType && modalContextType.type === "update" && /* @__PURE__ */ jsx251(UpdateModal, {
        info: modalContextType.info,
        knownBugs: modalContextType.knownBugs
      }),
      modalContextType && modalContextType.type === "install-packages" && /* @__PURE__ */ jsx251(InstallPackageModal, {
        packageManager: modalContextType.packageManager
      }),
      modalContextType && modalContextType.type === "quick-switcher" && /* @__PURE__ */ jsx251(QuickSwitcher_default, {
        readOnlyStudio,
...
var Editor = ({ Root, readOnlyStudio }) => {
  ...
  const [canvasMounted, setCanvasMounted] = React168.useState(false);
  const onMounted = useCallback126(() => {
    setCanvasMounted(true);
  }, []);
  const value = useMemo125(() => {
    if (!size4) {
      return null;
    }
    return {
  ...
  const MemoRoot = useMemo125(() => {
    return React168.memo(Root);
  }, [Root]);
  return /* @__PURE__ */ jsx252(HigherZIndex, {
    onEscape: noop,
    onOutsideClick: noop,
    children: /* @__PURE__ */ jsxs132(TimelineZoomContext, {
      children: [
        /* @__PURE__ */ jsx252(Internals59.CurrentScaleContext.Provider, {
          value,
          children: /* @__PURE__ */ jsxs132("div", {
            style: background2,
            children: [
              canvasMounted ? /* @__PURE__ */ jsx252(MemoRoot, {}) : null,
              /* @__PURE__ */ jsxs132(Internals59.CanUseRemotionHooksProvider, {
                children: [
                  /* @__PURE__ */ jsx252(EditorContent, {
                    readOnlyStudio,
                    children: /* @__PURE__ */ jsx252(TopPanel, {
                      drawRef,
                  ...
                  /* @__PURE__ */ jsx252(GlobalKeybindings, {})
                ]
              })
            ]
          })
        }),
        /* @__PURE__ */ jsx252(Modals, {
          readOnlyStudio
        }),
        /* @__PURE__ */ jsx252(NotificationCenter, {})
      ]
    })
  });
};
...
import { useCallback as useCallback127, useContext as useContext80, useMemo as useMemo126, useState as useState75 } from "react";
...
var PreviewSizeProvider = ({ children }) => {
  const [size4, setSizeState] = useState75(() => loadPreviewSizeOption());
  const [translation, setTranslation] = useState75(() => {
    return {
      x: 0,
      y: 0
    };
  });
  const { editorZoomGestures } = useContext80(EditorZoomGesturesContext);
  const setSize = useCallback127((newValue) => {
  ...
  const previewSizeCtx = useMemo126(() => {
    return {
  ...
  return /* @__PURE__ */ jsx253(Internals60.PreviewSizeContext.Provider, {
...
import { useCallback as useCallback128, useMemo as useMemo127, useState as useState76 } from "react";
import { jsx as jsx254 } from "react/jsx-runtime";
var CheckerboardProvider = ({ children }) => {
  const [checkerboard, setCheckerboardState] = useState76(() => loadCheckerboardOption());
  const setCheckerboard = useCallback128((newValue) => {
  ...
  const checkerboardCtx = useMemo127(() => {
    return {
      checkerboard,
      setCheckerboard
    };
  }, [checkerboard, setCheckerboard]);
  return /* @__PURE__ */ jsx254(CheckerboardContext.Provider, {
...
var MediaVolumeProvider = ({ children }) => {
  const [mediaMuted, setMediaMuted] = useState77(() => loadMuteOption());
  const [mediaVolume, setMediaVolume] = useState77(1);
  const mediaVolumeContextValue = useMemo128(() => {
    return {
      mediaMuted,
      mediaVolume
    };
  }, [mediaMuted, mediaVolume]);
  const setMediaVolumeContextValue = useMemo128(() => {
    return {
      setMediaMuted,
      setMediaVolume
    };
  }, []);
  return /* @__PURE__ */ jsx255(Internals61.MediaVolumeContext.Provider, {
    value: mediaVolumeContextValue,
    children: /* @__PURE__ */ jsx255(Internals61.SetMediaVolumeContext.Provider, {
...
import { useMemo as useMemo129, useState as useState78 } from "react";
import { jsx as jsx256 } from "react/jsx-runtime";
var ModalsProvider = ({ children }) => {
  const [modalContextType, setModalContextType] = useState78(null);
  const modalsContext = useMemo129(() => {
    return {
      selectedModal: modalContextType,
      setSelectedModal: setModalContextType
    };
  }, [modalContextType]);
  return /* @__PURE__ */ jsx256(ModalsContext.Provider, {
    value: modalsContext,
    children
  });
};
...
import { useEffect as useEffect73, useMemo as useMemo130, useState as useState79 } from "react";
...
var SetTimelineInOutProvider = ({ children }) => {
  const [inAndOutFrames, setInAndOutFrames] = useState79(() => loadMarks());
  const setTimelineInOutContextValue = useMemo130(() => {
    return {
      setInAndOutFrames
    };
  }, []);
  ...
  return /* @__PURE__ */ jsx257(TimelineInOutContext.Provider, {
    value: inAndOutFrames,
    children: /* @__PURE__ */ jsx257(SetTimelineInOutContext.Provider, {
...
import { useCallback as useCallback129, useMemo as useMemo131, useRef as useRef39, useState as useState80 } from "react";
import { jsx as jsx258 } from "react/jsx-runtime";
var ShowGuidesProvider = ({ children }) => {
  const [guidesList, setGuidesList] = useState80(() => loadGuidesList());
  const [selectedGuideId, setSelectedGuideId] = useState80(null);
  const [hoveredGuideId, setHoveredGuideId] = useState80(null);
  const [editorShowGuides, setEditorShowGuidesState] = useState80(() => loadEditorShowGuidesOption());
  const shouldCreateGuideRef = useRef39(false);
  const shouldDeleteGuideRef = useRef39(false);
  const setEditorShowGuides = useCallback129((newValue) => {
  ...
  const editorShowGuidesCtx = useMemo131(() => {
    return {
      editorShowGuides,
      setEditorShowGuides,
      guidesList,
  ...
  return /* @__PURE__ */ jsx258(EditorShowGuidesContext.Provider, {
...
import { useCallback as useCallback130, useMemo as useMemo132, useState as useState81 } from "react";
import { jsx as jsx259 } from "react/jsx-runtime";
var ShowRulersProvider = ({ children }) => {
  const [editorShowRulers, setEditorShowRulersState] = useState81(() => loadEditorShowRulersOption());
  const setEditorShowRulers = useCallback130((newValue) => {
  ...
  const editorShowRulersCtx = useMemo132(() => {
    return {
      editorShowRulers,
      setEditorShowRulers
    };
  }, [editorShowRulers, setEditorShowRulers]);
  return /* @__PURE__ */ jsx259(EditorShowRulersContext.Provider, {
...
import { useCallback as useCallback131, useMemo as useMemo133, useState as useState82 } from "react";
import { jsx as jsx260 } from "react/jsx-runtime";
var ZoomGesturesProvider = ({ children }) => {
  const [editorZoomGestures, setEditorZoomGesturesState] = useState82(() => loadEditorZoomGesturesOption());
  const setEditorZoomGestures = useCallback131((newValue) => {
  ...
  const editorZoomGesturesCtx = useMemo133(() => {
    return {
      editorZoomGestures,
      setEditorZoomGestures
    };
  }, [editorZoomGestures, setEditorZoomGestures]);
  return /* @__PURE__ */ jsx260(EditorZoomGesturesContext.Provider, {
...
var EditorContexts = ({ children, readOnlyStudio }) => {
  return /* @__PURE__ */ jsx261(ZodProvider, {
    children: /* @__PURE__ */ jsx261(PreviewServerConnection, {
      readOnlyStudio,
      children: /* @__PURE__ */ jsx261(RenderQueueContextProvider, {
        children: /* @__PURE__ */ jsx261(KeybindingContextProvider, {
          children: /* @__PURE__ */ jsx261(CheckerboardProvider, {
            children: /* @__PURE__ */ jsx261(ZoomGesturesProvider, {
              children: /* @__PURE__ */ jsx261(ShowRulersProvider, {
                children: /* @__PURE__ */ jsx261(ShowGuidesProvider, {
                  children: /* @__PURE__ */ jsx261(PreviewSizeProvider, {
                    children: /* @__PURE__ */ jsx261(ModalsProvider, {
                      children: /* @__PURE__ */ jsx261(MediaVolumeProvider, {
                        children: /* @__PURE__ */ jsx261(PlayerInternals20.PlayerEmitterProvider, {
                          currentPlaybackRate: null,
                          children: /* @__PURE__ */ jsx261(SidebarContextProvider, {
                            children: /* @__PURE__ */ jsx261(FolderContextProvider, {
                              children: /* @__PURE__ */ jsx261(HighestZIndexProvider, {
                                children: /* @__PURE__ */ jsx261(SetTimelineInOutProvider, {
                                  children
                                })
                              })
                            })
...
import { jsx as jsx262, jsxs as jsxs133 } from "react/jsx-runtime";
var container59 = {
  position: "fixed",
  justifyContent: "flex-end",
  alignItems: "flex-start",
...
var ServerDisconnected = () => {
  const { previewServerState: ctx } = useContext81(StudioServerConnectionCtx);
...
var injectCSS = () => {
  ...
  Internals62.CSSUtils.injectCSS(makeDefaultGlobalCSS());
  injected = true;
};

// src/Studio.tsx
import { jsx as jsx263, jsxs as jsxs134 } from "react/jsx-runtime";
...
var Studio = ({ rootComponent, readOnly }) => {
  useLayoutEffect2(() => {
    ...
    Internals63.enableSequenceStackTraces();
    return () => {
  ...
  return /* @__PURE__ */ jsx263(Internals63.RemotionRoot, {
    ...
    children: /* @__PURE__ */ jsxs134(EditorContexts, {
      ...
      children: [
        /* @__PURE__ */ jsx263(Editor, {
          readOnlyStudio: readOnly,
          Root: rootComponent
        }),
        readOnly ? null : createPortal(/* @__PURE__ */ jsx263(ServerDisconnected, {}), getServerDisconnectedDomElement())
      ]
    })
  });
};
...
import { useEffect as useEffect74, useState as useState83 } from "react";
import { AbsoluteFill as AbsoluteFill5 } from "remotion";
import { jsx as jsx264, jsxs as jsxs135 } from "react/jsx-runtime";
var label10 = {
  fontSize: 13,
  color: "white",
  fontFamily: "Arial, Helvetica, sans-serif"
...
var NoRegisterRoot = () => {
  const [show, setShow] = useState83(() => false);
  useEffect74(() => {
    const timeout = setTimeout(() => {
      setShow(true);
    }, 2000);
  ...
  return /* @__PURE__ */ jsxs135(AbsoluteFill5, {
    style: container60,
    children: [
      /* @__PURE__ */ jsx264("div", {
        style: label10,
...
var mountRemotionOverlay = () => {
  if (ReactDOM8.createRoot) {
    ReactDOM8.createRoot(document.getElementById("remotion-error-overlay")).render(/* @__PURE__ */ jsx265(Overlay, {}));
  } else {
    ReactDOM8.render(/* @__PURE__ */ jsx265(Overlay, {}), document.getElementById("remotion-error-overlay"));
  }
};
...
Internals64.CSSUtils.injectCSS(Internals64.CSSUtils.makeDefaultPreviewCSS(null, "#1f2428"));
var root = null;
var getRootForElement = () => {
  if (root) {
    return root;
  }
  root = ReactDOM9.createRoot(Internals64.getPreviewDomElement());
  return root;
};
var renderToDOM = (content7) => {
  if (!ReactDOM9.createRoot) {
    if (NoReactInternals15.ENABLE_V5_BREAKING_CHANGES) {
      throw new Error("Remotion 5.0 does only support React 18+. However, ReactDOM.createRoot() is undefined.");
    }
    ReactDOM9.render(content7, Internals64.getPreviewDomElement());
    return;
  }
  getRootForElement().render(content7);
};
renderToDOM(/* @__PURE__ */ jsx266(NoRegisterRoot, {}));
Internals64.waitForRoot((NewRoot) => {
  renderToDOM(/* @__PURE__ */ jsx266(Studio, {
    readOnly: false,
