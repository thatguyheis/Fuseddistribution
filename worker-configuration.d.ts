/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f06459a3d626367af1211f4b6b891803)
// Runtime types generated with workerd@1.20260617.1 2026-04-15 nodejs_compat
interface __BaseEnv_Env {
	SPOT_KV: KVNamespace;
	REELS_KV: KVNamespace;
	ASSETS: Fetcher;
	BUFFER_ACCESS_TOKEN: string;
	SUBMISSION_RATE_LIMITER: DurableObjectNamespace<import("./src/worker").SubmissionRateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "SubmissionRateLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUFFER_ACCESS_TOKEN">> {}
}
