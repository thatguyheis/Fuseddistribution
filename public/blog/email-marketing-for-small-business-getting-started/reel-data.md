# Reel Data: email-marketing-for-small-business-getting-started
topic: tech
format: long-form

hook: 88% of consumers trust online reviews as much as personal recommendations.
hook_type: contrarian_stat

## segments
- type: overlay
  text: WANT WEBSITE ACTUALLY GETS
...
- type: overlay
  text: OPTIONAL FOUNDATION LOCAL ONLINE
...
- type: overlay
  text: INCLUDES BUSINESS NAME ADDRESS
...
- type: stat
  text: 92% CONSUMERS SAY ONLINE REVIEWS
...
- type: overlay
  text: SHARE TIPS ADVICE INSIGHTS
...
- type: stat
  text: 85% CONSUMERS READ ONLINE REVIEWS
...
- type: overlay
  text: EXAMPLE EMAIL SEQUENCE WELCOME
...
## shared
discussion_question: Considering all these tips, what’s one thing you’d prioritize to?
hashtags: #LocalBusiness #SmallBusinessTips #DigitalMarketing #GoogleMyBusiness #WebDesign

## media_queries
- segment: 0
  query: "email marketing for small business getting started"
  prefer: video
- segment: 1
  query: "email marketing for small business getting started want website actually"
  prefer: photo
- segment: 2
  query: "email marketing for small business getting started optional foundation local"
  prefer: photo
- segment: 3
  query: "email marketing for small business getting started includes business name"
  prefer: photo
- segment: 4
  query: "email marketing for small business getting started 92 consumers say"
  prefer: photo
- segment: 5
  query: "email marketing for small business getting started share tips advice"
  prefer: photo
- segment: 6
  query: "email marketing for small business getting started 85 consumers read"
  prefer: photo
- segment: 7
  query: "email marketing for small business getting started example email sequence"
  prefer: photo
- segment: 8
  query: "email marketing for small business getting started contact today free"
  prefer: photo
- segment: 9
  query: "email marketing for small business getting started customer feedback"
  prefer: photo
